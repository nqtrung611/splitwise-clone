var Sd=Object.defineProperty;var Rd=(s,e,t)=>e in s?Sd(s,e,{enumerable:!0,configurable:!0,writable:!0,value:t}):s[e]=t;var K=(s,e,t)=>Rd(s,typeof e!="symbol"?e+"":e,t);(function(){const e=document.createElement("link").relList;if(e&&e.supports&&e.supports("modulepreload"))return;for(const r of document.querySelectorAll('link[rel="modulepreload"]'))n(r);new MutationObserver(r=>{for(const i of r)if(i.type==="childList")for(const a of i.addedNodes)a.tagName==="LINK"&&a.rel==="modulepreload"&&n(a)}).observe(document,{childList:!0,subtree:!0});function t(r){const i={};return r.integrity&&(i.integrity=r.integrity),r.referrerPolicy&&(i.referrerPolicy=r.referrerPolicy),r.crossOrigin==="use-credentials"?i.credentials="include":r.crossOrigin==="anonymous"?i.credentials="omit":i.credentials="same-origin",i}function n(r){if(r.ep)return;r.ep=!0;const i=t(r);fetch(r.href,i)}})();function Wa(s,e){const t={};return e.forEach(n=>{t[n.id]={userId:n.id,owes:{},owedBy:{},totalOwes:0,totalOwed:0}}),s.forEach(n=>{const r=n.paidBy;n.splitBetween.forEach(i=>{const a=i.userId;let c;n.splitType==="equal"?c=n.amount/n.splitBetween.length:c=i.amount||0,a!==r&&(t[a].owes[r]||(t[a].owes[r]=0),t[r].owedBy[a]||(t[r].owedBy[a]=0),t[a].owes[r]+=c,t[r].owedBy[a]+=c)})}),Object.values(t).forEach(n=>{n.totalOwes=Object.values(n.owes).reduce((r,i)=>r+i,0),n.totalOwed=Object.values(n.owedBy).reduce((r,i)=>r+i,0)}),e.forEach(n=>{e.forEach(r=>{if(n.id!==r.id){const i=t[n.id].owes[r.id]||0,a=t[r.id].owes[n.id]||0;if(i>0&&a>0){const c=i-a;c>0?(t[n.id].owes[r.id]=c,t[r.id].owedBy[n.id]=c,delete t[r.id].owes[n.id],delete t[n.id].owedBy[r.id]):c<0?(t[r.id].owes[n.id]=Math.abs(c),t[n.id].owedBy[r.id]=Math.abs(c),delete t[n.id].owes[r.id],delete t[r.id].owedBy[n.id]):(delete t[n.id].owes[r.id],delete t[r.id].owes[n.id],delete t[n.id].owedBy[r.id],delete t[r.id].owedBy[n.id])}}})}),Object.values(t).forEach(n=>{n.totalOwes=Object.values(n.owes).reduce((r,i)=>r+i,0),n.totalOwed=Object.values(n.owedBy).reduce((r,i)=>r+i,0)}),t}function ie(s){return new Intl.NumberFormat("vi-VN",{style:"currency",currency:"VND",minimumFractionDigits:0,maximumFractionDigits:0}).format(s)}function Cd(){return Math.random().toString(36).substr(2,9)}function Pd(s){const e=[];if((!s.description||s.description.trim().length===0)&&e.push("Mô tả chi phí không được để trống"),(!s.amount||s.amount<=0)&&e.push("Số tiền phải lớn hơn 0"),s.paidBy||e.push("Vui lòng chọn người trả tiền"),(!s.splitBetween||s.splitBetween.length===0)&&e.push("Vui lòng chọn ít nhất một người để chia chi phí"),s.category||e.push("Vui lòng chọn danh mục chi phí"),s.splitType==="custom"&&s.splitBetween){const t=s.splitBetween.reduce((n,r)=>n+(r.amount||0),0);Math.abs(t-(s.amount||0))>1&&e.push("Tổng số tiền chia phải bằng tổng chi phí")}return e}function xd(s){const e=[],t=Object.values(s).map(c=>({userId:c.userId,netAmount:c.totalOwed-c.totalOwes})),n=t.filter(c=>c.netAmount>0).sort((c,u)=>u.netAmount-c.netAmount),r=t.filter(c=>c.netAmount<0).sort((c,u)=>c.netAmount-u.netAmount);let i=0,a=0;for(;i<n.length&&a<r.length;){const c=n[i],u=r[a],d=Math.min(c.netAmount,Math.abs(u.netAmount));d>0&&e.push({from:u.userId,to:c.userId,amount:d}),c.netAmount-=d,u.netAmount+=d,c.netAmount===0&&i++,u.netAmount===0&&a++}return e}class kd{constructor(e,t,n){K(this,"expense");K(this,"users");K(this,"currentUser");this.expense=e,this.users=t,this.currentUser=n}render(){var r;const e=this.users.find(i=>i.id===this.expense.paidBy),t=((r=this.currentUser)==null?void 0:r.id)||"",n=this.expense.splitBetween.some(i=>i.userId===t)||this.expense.paidBy===t;return`
              ...
              <div class="mt-2">
                <details class="text-xs text-gray-500">
                  ...
                  <div class="mt-2 pl-4 space-y-1">
                    ${this.expense.splitBetween.map(i=>{const a=this.users.find(c=>c.id===i.userId);return`
                        <div class="flex justify-between">
                          <span>${a==null?void 0:a.name}</span>
                          <span>${ie(i.amount||0)}</span>
                        </div>
                      `}).join("")}
                  </div>
                </details>
    ...
    `}renderUserInvolvement(){var a;const e=((a=this.currentUser)==null?void 0:a.id)||"",t=this.expense.splitBetween.find(c=>c.userId===e),n=(t==null?void 0:t.amount)||0,r=this.expense.paidBy===e,i=!!t;if(r&&i){const c=this.expense.amount-n;return`
      ...
      `}return""}getCategoryName(e){return{food:"🍽️ Ăn uống",transportation:"🚗 Di chuyển",accommodation:"🏠 Lưu trú",entertainment:"🎉 Giải trí",shopping:"🛍️ Mua sắm",utilities:"⚡ Tiện ích",other:"📦 Khác"}[e]||"📦 Khác"}}class Dd{constructor(e,t,n){K(this,"balance");K(this,"users");K(this,"allBalances");this.balance=e,this.users=t,this.allBalances=n}render(){const e=this.balance.totalOwed,t=this.balance.totalOwes,n=e-t;return`
      <div class="card">
    ...
    `}renderDetailedBalances(){let e='<div class="space-y-3 mb-6">';const t=Object.entries(this.balance.owedBy).filter(([r,i])=>i>0);t.length>0&&(e+='<h3 class="font-semibold text-green-700 text-sm mb-2">💚 Ai nợ bạn:</h3>',t.forEach(([r,i])=>{const a=this.users.find(c=>c.id===r);e+=`
        ...
        `})),e+="</div>",e}renderSettlementSuggestions(){const t=xd(this.allBalances).filter(r=>r.from===this.balance.userId||r.to===this.balance.userId);if(t.length===0)return"";let n=`
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */function yn(s){try{return(s.startsWith("http://")||s.startsWith("https://")?new URL(s).hostname:s).endsWith(".cloudworkstations.dev")}catch{return!1}}async function xl(s){return(await fetch(s,{credentials:"include"})).ok}/**
 * @license
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */var q;(function(s){s[s.DEBUG=0]="DEBUG",s[s.VERBOSE=1]="VERBOSE",s[s.INFO=2]="INFO",s[s.WARN=3]="WARN",s[s.ERROR=4]="ERROR",s[s.SILENT=5]="SILENT"})(q||(q={}));const gf={debug:q.DEBUG,verbose:q.VERBOSE,info:q.INFO,warn:q.WARN,error:q.ERROR,silent:q.SILENT},yf=q.INFO,_f={[q.DEBUG]:"log",[q.VERBOSE]:"log",[q.INFO]:"info",[q.WARN]:"warn",[q.ERROR]:"error"},vf=(s,e,...t)=>{if(e<s.logLevel)return;const n=new Date().toISOString(),r=_f[e];if(r)console[r](`[${n}]  ${s.name}:`,...t);else throw new Error(`Attempted to log a message with an invalid logType (value: ${e})`)};class Xi{constructor(e){this.name=e,this._logLevel=yf,this._logHandler=vf,this._userLogHandler=null}get logLevel(){return this._logLevel}set logLevel(e){if(!(e in q))throw new TypeError(`Invalid value "${e}" assigned to \`logLevel\``);this._logLevel=e}setLogLevel(e){this._logLevel=typeof e=="string"?gf[e]:e}get logHandler(){return this._logHandler}set logHandler(e){if(typeof e!="function")throw new TypeError("Value assigned to `logHandler` must be a function");this._logHandler=e}get userLogHandler(){return this._userLogHandler}set userLogHandler(e){this._userLogHandler=e}debug(...e){this._userLogHandler&&this._userLogHandler(this,q.DEBUG,...e),this._logHandler(this,q.DEBUG,...e)}log(...e){this._userLogHandler&&this._userLogHandler(this,q.VERBOSE,...e),this._logHandler(this,q.VERBOSE,...e)}info(...e){this._userLogHandler&&this._userLogHandler(this,q.INFO,...e),this._logHandler(this,q.INFO,...e)}warn(...e){this._userLogHandler&&this._userLogHandler(this,q.WARN,...e),this._logHandler(this,q.WARN,...e)}error(...e){this._userLogHandler&&this._userLogHandler(this,q.ERROR,...e),this._logHandler(this,q.ERROR,...e)}}const Ef=(s,e)=>e.some(t=>s instanceof t);let Ya,Ja;function wf(){return Ya||(Ya=[IDBDatabase,IDBObjectStore,IDBIndex,IDBCursor,IDBTransaction])}function Tf(){return Ja||(Ja=[IDBCursor.prototype.advance,IDBCursor.prototype.continue,IDBCursor.prototype.continuePrimaryKey])}const Dl=new WeakMap,Ai=new WeakMap,Vl=new WeakMap,ai=new WeakMap,Yi=new WeakMap;function If(s){const e=new Promise((t,n)=>{const r=()=>{s.removeEventListener("success",i),s.removeEventListener("error",a)},i=()=>{t(pt(s.result)),r()},a=()=>{n(s.error),r()};s.addEventListener("success",i),s.addEventListener("error",a)});return e.then(t=>{t instanceof IDBCursor&&Dl.set(t,s)}).catch(()=>{}),Yi.set(e,s),e}function Af(s){if(Ai.has(s))return;const e=new Promise((t,n)=>{const r=()=>{s.removeEventListener("complete",i),s.removeEventListener("error",a),s.removeEventListener("abort",a)},i=()=>{t(),r()},a=()=>{n(s.error||new DOMException("AbortError","AbortError")),r()};s.addEventListener("complete",i),s.addEventListener("error",a),s.addEventListener("abort",a)});Ai.set(s,e)}let bi={get(s,e,t){if(s instanceof IDBTransaction){if(e==="done")return Ai.get(s);if(e==="objectStoreNames")return s.objectStoreNames||Vl.get(s);if(e==="store")return t.objectStoreNames[1]?void 0:t.objectStore(t.objectStoreNames[0])}return pt(s[e])},set(s,e,t){return s[e]=t,!0},has(s,e){return s instanceof IDBTransaction&&(e==="done"||e==="store")?!0:e in s}};function bf(s){bi=s(bi)}function Sf(s){return s===IDBDatabase.prototype.transaction&&!("objectStoreNames"in IDBTransaction.prototype)?function(e,...t){const n=s.call(ci(this),e,...t);return Vl.set(n,e.sort?e.sort():[e]),pt(n)}:Tf().includes(s)?function(...e){return s.apply(ci(this),e),pt(Dl.get(this))}:function(...e){return pt(s.apply(ci(this),e))}}function Rf(s){return typeof s=="function"?Sf(s):(s instanceof IDBTransaction&&Af(s),Ef(s,wf())?new Proxy(s,bi):s)}function pt(s){if(s instanceof IDBRequest)return If(s);if(ai.has(s))return ai.get(s);const e=Rf(s);return e!==s&&(ai.set(s,e),Yi.set(e,s)),e}const ci=s=>Yi.get(s);function Cf(s,e,{blocked:t,upgrade:n,blocking:r,terminated:i}={}){const a=indexedDB.open(s,e),c=pt(a);return n&&a.addEventListener("upgradeneeded",u=>{n(pt(a.result),u.oldVersion,u.newVersion,pt(a.transaction),u)}),t&&a.addEventListener("blocked",u=>t(u.oldVersion,u.newVersion,u)),c.then(u=>{i&&u.addEventListener("close",()=>i()),r&&u.addEventListener("versionchange",d=>r(d.oldVersion,d.newVersion,d))}).catch(()=>{}),c}const Pf=["get","getKey","getAll","getAllKeys","count"],xf=["put","add","delete","clear"],li=new Map;function Za(s,e){if(!(s instanceof IDBDatabase&&!(e in s)&&typeof e=="string"))return;if(li.get(e))return li.get(e);const t=e.replace(/FromIndex$/,""),n=e!==t,r=xf.includes(t);if(!(t in(n?IDBIndex:IDBObjectStore).prototype)||!(r||Pf.includes(t)))return;const i=async function(a,...c){const u=this.transaction(a,r?"readwrite":"readonly");let d=u.store;return n&&(d=d.index(c.shift())),(await Promise.all([d[t](...c),r&&u.done]))[0]};return li.set(e,i),i}bf(s=>({...s,get:(e,t,n)=>Za(e,t)||s.get(e,t,n),has:(e,t)=>!!Za(e,t)||s.has(e,t)}));/**
 * @license
 * Copyright 2019 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */class kf{constructor(e){this.container=e}getPlatformInfoString(){return this.container.getProviders().map(t=>{if(Df(t)){const n=t.getImmediate();return`${n.library}/${n.version}`}else return null}).filter(t=>t).join(" ")}}function Df(s){const e=s.getComponent();return(e==null?void 0:e.type)==="VERSION"}const Si="@firebase/app",ec="0.14.4";/**
 * @license
 * Copyright 2019 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */function vm(s){ln(new Bt("platform-logger",e=>new kf(e),"PRIVATE")),ln(new Bt("heartbeat",e=>new pm(e),"PRIVATE")),yt(Si,ec,s),yt(Si,ec,"esm2020"),yt("fire-js","")}vm("");var ic=typeof globalThis<"u"?globalThis:typeof window<"u"?window:typeof global<"u"?global:typeof self<"u"?self:{};/** @license
...
*/var Ul,jn,Bl,$s,Pi,$l,jl,ql;(function(){var s,e=Object.defineProperty;function t(o){o=[typeof globalThis=="object"&&globalThis,o,typeof window=="object"&&window,typeof self=="object"&&self,typeof Ls=="object"&&Ls];for(var l=0;l<o.length;++l){var h=o[l];if(h&&h.Math==Math)return h}throw Error("Cannot find global object")}var n=t(this);function r(o,l){if(l)e:{var h=n;o=o.split(".");for(var m=0;m<o.length-1;m++){var I=o[m];if(!(I in h))break e;h=h[I]}o=o[o.length-1],m=h[o],l=l(m),l!=m&&l!=null&&e(h,o,{configurable:!0,writable:!0,value:l})}}r("Symbol.dispose",function(o){return o||Symbol("Symbol.dispose")}),r("Array.prototype.values",function(o){return o||function(){return this[Symbol.iterator]()}}),r("Object.entries",function(o){return o||function(l){var h=[],m;for(m in l)Object.prototype.hasOwnProperty.call(l,m)&&h.push([m,l[m]]);return h}});/** @license
 ...
 Copyright The Closure Library Authors.
 SPDX-License-Identifier: Apache-2.0
*/var i=i||{},a=this||self;function c(o){var l=typeof o;return l=="object"&&o!=null||l=="function"}function u(o,l,h){return o.call.apply(o.bind,arguments)}function d(o,l,h){return d=u,d.apply(null,arguments)}function f(o,l){var h=Array.prototype.slice.call(arguments,1);return function(){var m=h.slice();return m.push.apply(m,arguments),o.apply(this,m)}}function p(o,l){function h(){}h.prototype=l.prototype,o.Z=l.prototype,o.prototype=new h,o.prototype.constructor=o,o.Ob=function(m,I,b){for(var k=Array(arguments.length-2),j=2;j<arguments.length;j++)k[j-2]=arguments[j];return l.prototype[I].apply(m,k)}}var v=typeof AsyncContext<"u"&&typeof AsyncContext.Snapshot=="function"?o=>o&&AsyncContext.Snapshot.wrap(o):o=>o;function S(o){const l=o.length;if(l>0){const h=Array(l);for(let m=0;m<l;m++)h[m]=o[m];return h}return[]}function P(o,l){for(let m=1;m<arguments.length;m++){const I=arguments[m];var h=typeof I;if(h=h!="object"?h:I?Array.isArray(I)?"array":h:"null",h=="array"||h=="object"&&typeof I.length=="number"){h=o.length||0;const b=I.length||0;o.length=h+b;for(let k=0;k<b;k++)o[h+k]=I[k]}else o.push(I)}}class D{constructor(l,h){this.i=l,this.j=h,this.h=0,this.g=null}get(){let l;return this.h>0?(this.h--,l=this.g,this.g=l.next,l.next=null):l=this.i(),l}}function x(o){a.setTimeout(()=>{throw o},0)}function B(){var o=w;let l=null;return o.g&&(l=o.g,o.g=o.g.next,o.g||(o.h=null),l.next=null),l}class ${constructor(){this.h=this.g=null}add(l,h){const m=W.get();m.set(l,h),this.h?this.h.next=m:this.g=m,this.h=m}}var W=new D(()=>new se,o=>o.reset());class se{constructor(){this.next=this.g=this.h=null}set(l,h){this.h=l,this.g=h,this.next=null}reset(){this.next=this.g=this.h=null}}let Ce,le=!1,w=new $,g=()=>{const o=Promise.resolve(void 0);Ce=()=>{o.then(_)}};function _(){for(var o;o=B();){try{o.h.call(o.g)}catch(h){x(h)}var l=W;l.j(o),l.h<100&&(l.h++,o.next=l.g,l.g=o)}le=!1}function T(){this.u=this.u,this.C=this.C}T.prototype.u=!1,T.prototype.dispose=function(){this.u||(this.u=!0,this.N())},T.prototype[Symbol.dispose]=function(){this.dispose()},T.prototype.N=function(){if(this.C)for(;this.C.length;)this.C.shift()()};function E(o,l){this.type=o,this.g=this.target=l,this.defaultPrevented=!1}E.prototype.h=function(){this.defaultPrevented=!0};var A=function(){if(!a.addEventListener||!Object.defineProperty)return!1;var o=!1,l=Object.defineProperty({},"passive",{get:function(){o=!0}});try{const h=()=>{};a.addEventListener("test",h,l),a.removeEventListener("test",h,l)}catch{}return o}();function y(o){return/^[\s\xa0]*$/.test(o)}function be(o,l){E.call(this,o?o.type:""),this.relatedTarget=this.g=this.target=null,this.button=this.screenY=this.screenX=this.clientY=this.clientX=0,this.key="",this.metaKey=this.shiftKey=this.altKey=this.ctrlKey=!1,this.state=null,this.pointerId=0,this.pointerType="",this.i=null,o&&this.init(o,l)}p(be,E),be.prototype.init=function(o,l){const h=this.type=o.type,m=o.changedTouches&&o.changedTouches.length?o.changedTouches[0]:null;this.target=o.target||o.srcElement,this.g=l,l=o.relatedTarget,l||(h=="mouseover"?l=o.fromElement:h=="mouseout"&&(l=o.toElement)),this.relatedTarget=l,m?(this.clientX=m.clientX!==void 0?m.clientX:m.pageX,this.clientY=m.clientY!==void 0?m.clientY:m.pageY,this.screenX=m.screenX||0,this.screenY=m.screenY||0):(this.clientX=o.clientX!==void 0?o.clientX:o.pageX,this.clientY=o.clientY!==void 0?o.clientY:o.pageY,this.screenX=o.screenX||0,this.screenY=o.screenY||0),this.button=o.button,this.key=o.key||"",this.ctrlKey=o.ctrlKey,this.altKey=o.altKey,this.shiftKey=o.shiftKey,this.metaKey=o.metaKey,this.pointerId=o.pointerId||0,this.pointerType=o.pointerType,this.state=o.state,this.i=o,o.defaultPrevented&&be.Z.h.call(this)},be.prototype.h=function(){be.Z.h.call(this);const o=this.i;o.preventDefault?o.preventDefault():o.returnValue=!1};var Ct="closure_listenable_"+(Math.random()*1e6|0),Kh=0;function Qh(o,l,h,m,I){this.listener=o,this.proxy=null,this.src=l,this.type=h,this.capture=!!m,this.ha=I,this.key=++Kh,this.da=this.fa=!1}function vs(o){o.da=!0,o.listener=null,o.proxy=null,o.src=null,o.ha=null}function Es(o,l,h){for(const m in o)l.call(h,o[m],m,o)}function Xh(o,l){for(const h in o)l.call(void 0,o[h],h,o)}function Go(o){const l={};for(const h in o)l[h]=o[h];return l}const Wo="constructor hasOwnProperty isPrototypeOf propertyIsEnumerable toLocaleString toString valueOf".split(" ");function Ko(o,l){let h,m;for(let I=1;I<arguments.length;I++){m=arguments[I];for(h in m)o[h]=m[h];for(let b=0;b<Wo.length;b++)h=Wo[b],Object.prototype.hasOwnProperty.call(m,h)&&(o[h]=m[h])}}function ws(o){this.src=o,this.g={},this.h=0}ws.prototype.add=function(o,l,h,m,I){const b=o.toString();o=this.g[b],o||(o=this.g[b]=[],this.h++);const k=Mr(o,l,m,I);return k>-1?(l=o[k],h||(l.fa=!1)):(l=new Qh(l,this.src,b,!!m,I),l.fa=h,o.push(l)),l};function Or(o,l){const h=l.type;if(h in o.g){var m=o.g[h],I=Array.prototype.indexOf.call(m,l,void 0),b;(b=I>=0)&&Array.prototype.splice.call(m,I,1),b&&(vs(l),o.g[h].length==0&&(delete o.g[h],o.h--))}}function Mr(o,l,h,m){for(let I=0;I<o.length;++I){const b=o[I];if(!b.da&&b.listener==l&&b.capture==!!h&&b.ha==m)return I}return-1}var Fr="closure_lm_"+(Math.random()*1e6|0),Ur={};function Qo(o,l,h,m,I){if(Array.isArray(l)){for(let b=0;b<l.length;b++)Qo(o,l[b],h,m,I);return null}return h=Jo(h),o&&o[Ct]?o.J(l,h,c(m)?!!m.capture:!1,I):Yh(o,l,h,!1,m,I)}function Yh(o,l,h,m,I,b){if(!l)throw Error("Invalid event type");const k=c(I)?!!I.capture:!!I;let j=$r(o);if(j||(o[Fr]=j=new ws(o)),h=j.add(l,h,m,k,b),h.proxy)return h;if(m=Jh(),h.proxy=m,m.src=o,m.listener=h,o.addEventListener)A||(I=k),I===void 0&&(I=!1),o.addEventListener(l.toString(),m,I);else if(o.attachEvent)o.attachEvent(Yo(l.toString()),m);else if(o.addListener&&o.removeListener)o.addListener(m);else throw Error("addEventListener and attachEvent are unavailable.");return h}function Jh(){function o(h){return l.call(o.src,o.listener,h)}const l=Zh;return o}function Xo(o,l,h,m,I){if(Array.isArray(l))for(var b=0;b<l.length;b++)Xo(o,l[b],h,m,I);else m=c(m)?!!m.capture:!!m,h=Jo(h),o&&o[Ct]?(o=o.i,b=String(l).toString(),b in o.g&&(l=o.g[b],h=Mr(l,h,m,I),h>-1&&(vs(l[h]),Array.prototype.splice.call(l,h,1),l.length==0&&(delete o.g[b],o.h--)))):o&&(o=$r(o))&&(l=o.g[l.toString()],o=-1,l&&(o=Mr(l,h,m,I)),(h=o>-1?l[o]:null)&&Br(h))}function Br(o){if(typeof o!="number"&&o&&!o.da){var l=o.src;if(l&&l[Ct])Or(l.i,o);else{var h=o.type,m=o.proxy;l.removeEventListener?l.removeEventListener(h,m,o.capture):l.detachEvent?l.detachEvent(Yo(h),m):l.addListener&&l.removeListener&&l.removeListener(m),(h=$r(l))?(Or(h,o),h.h==0&&(h.src=null,l[Fr]=null)):vs(o)}}}function Yo(o){return o in Ur?Ur[o]:Ur[o]="on"+o}function Zh(o,l){if(o.da)o=!0;else{l=new be(l,this);const h=o.listener,m=o.ha||o.src;o.fa&&Br(o),o=h.call(m,l)}return o}function $r(o){return o=o[Fr],o instanceof ws?o:null}var jr="__closure_events_fn_"+(Math.random()*1e9>>>0);function Jo(o){return typeof o=="function"?o:(o[jr]||(o[jr]=function(l){return o.handleEvent(l)}),o[jr])}function ye(){T.call(this),this.i=new ws(this),this.M=this,this.G=null}p(ye,T),ye.prototype[Ct]=!0,ye.prototype.removeEventListener=function(o,l,h,m){Xo(this,o,l,h,m)};function Te(o,l){var h,m=o.G;if(m)for(h=[];m;m=m.G)h.push(m);if(o=o.M,m=l.type||l,typeof l=="string")l=new E(l,o);else if(l instanceof E)l.target=l.target||o;else{var I=l;l=new E(m,o),Ko(l,I)}I=!0;let b,k;if(h)for(k=h.length-1;k>=0;k--)b=l.g=h[k],I=Ts(b,m,!0,l)&&I;if(b=l.g=o,I=Ts(b,m,!0,l)&&I,I=Ts(b,m,!1,l)&&I,h)for(k=0;k<h.length;k++)b=l.g=h[k],I=Ts(b,m,!1,l)&&I}ye.prototype.N=function(){if(ye.Z.N.call(this),this.i){var o=this.i;for(const l in o.g){const h=o.g[l];for(let m=0;m<h.length;m++)vs(h[m]);delete o.g[l],o.h--}}this.G=null},ye.prototype.J=function(o,l,h,m){return this.i.add(String(o),l,!1,h,m)},ye.prototype.K=function(o,l,h,m){return this.i.add(String(o),l,!0,h,m)};function Ts(o,l,h,m){if(l=o.i.g[String(l)],!l)return!0;l=l.concat();let I=!0;for(let b=0;b<l.length;++b){const k=l[b];if(k&&!k.da&&k.capture==h){const j=k.listener,ue=k.ha||k.src;k.fa&&Or(o.i,k),I=j.call(ue,m)!==!1&&I}}return I&&!m.defaultPrevented}function ed(o,l){if(typeof o!="function")if(o&&typeof o.handleEvent=="function")o=d(o.handleEvent,o);else throw Error("Invalid listener argument");return Number(l)>2147483647?-1:a.setTimeout(o,l||0)}function Zo(o){o.g=ed(()=>{o.g=null,o.i&&(o.i=!1,Zo(o))},o.l);const l=o.h;o.h=null,o.m.apply(null,l)}class td extends T{constructor(l,h){super(),this.m=l,this.l=h,this.h=null,this.i=!1,this.g=null}j(l){this.h=arguments,this.g?this.i=!0:Zo(this)}N(){super.N(),this.g&&(a.clearTimeout(this.g),this.g=null,this.i=!1,this.h=null)}}function Sn(o){T.call(this),this.h=o,this.g={}}p(Sn,T);var ea=[];function ta(o){Es(o.g,function(l,h){this.g.hasOwnProperty(h)&&Br(l)},o),o.g={}}Sn.prototype.N=function(){Sn.Z.N.call(this),ta(this)},Sn.prototype.handleEvent=function(){throw Error("EventHandler.handleEvent not implemented")};var qr=a.JSON.stringify,nd=a.JSON.parse,sd=class{stringify(o){return a.JSON.stringify(o,void 0)}parse(o){return a.JSON.parse(o,void 0)}};function na(){}function sa(){}var Rn={OPEN:"a",hb:"b",ERROR:"c",tb:"d"};function zr(){E.call(this,"d")}p(zr,E);function Hr(){E.call(this,"c")}p(Hr,E);var Pt={},ra=null;function Is(){return ra=ra||new ye}Pt.Ia="serverreachability";function ia(o){E.call(this,Pt.Ia,o)}p(ia,E);function Cn(o){const l=Is();Te(l,new ia(l))}Pt.STAT_EVENT="statevent";function oa(o,l){E.call(this,Pt.STAT_EVENT,o),this.stat=l}p(oa,E);function Ie(o){const l=Is();Te(l,new oa(l,o))}Pt.Ja="timingevent";function aa(o,l){E.call(this,Pt.Ja,o),this.size=l}p(aa,E);function Pn(o,l){if(typeof o!="function")throw Error("Fn must not be null and must be a function");return a.setTimeout(function(){o()},l)}function xn(){this.g=!0}xn.prototype.ua=function(){this.g=!1};function rd(o,l,h,m,I,b){o.info(function(){if(o.g)if(b){var k="",j=b.split("&");for(let X=0;X<j.length;X++){var ue=j[X].split("=");if(ue.length>1){const de=ue[0];ue=ue[1];const Me=de.split("_");k=Me.length>=2&&Me[1]=="type"?k+(de+"="+ue+"&"):k+(de+"=redacted&")}}}else k=null;else k=b;return"XMLHTTP REQ ("+m+") [attempt "+I+"]: "+l+`
`+h+`
`+k})}function id(o,l,h,m,I,b,k){o.info(function(){return"XMLHTTP RESP ("+m+") [ attempt "+I+"]: "+l+`
`+h+`
`+b+" "+k})}function Kt(o,l,h,m){o.info(function(){return"XMLHTTP TEXT ("+l+"): "+ad(o,h)+(m?" "+m:"")})}function od(o,l){o.info(function(){return"TIMEOUT: "+l})}xn.prototype.info=function(){};function ad(o,l){if(!o.g)return l;if(!l)return null;try{const b=JSON.parse(l);if(b){for(o=0;o<b.length;o++)if(Array.isArray(b[o])){var h=b[o];if(!(h.length<2)){var m=h[1];if(Array.isArray(m)&&!(m.length<1)){var I=m[0];if(I!="noop"&&I!="stop"&&I!="close")for(let k=1;k<m.length;k++)m[k]=""}}}}return qr(b)}catch{return l}}var As={NO_ERROR:0,cb:1,qb:2,pb:3,kb:4,ob:5,rb:6,Ga:7,TIMEOUT:8,ub:9},ca={ib:"complete",Fb:"success",ERROR:"error",Ga:"abort",xb:"ready",yb:"readystatechange",TIMEOUT:"timeout",sb:"incrementaldata",wb:"progress",lb:"downloadprogress",Nb:"uploadprogress"},la;function Gr(){}p(Gr,na),Gr.prototype.g=function(){return new XMLHttpRequest},la=new Gr;function kn(o){return encodeURIComponent(String(o))}function cd(o){var l=1;o=o.split(":");const h=[];for(;l>0&&o.length;)h.push(o.shift()),l--;return o.length&&h.push(o.join(":")),h}function st(o,l,h,m){this.j=o,this.i=l,this.l=h,this.S=m||1,this.V=new Sn(this),this.H=45e3,this.J=null,this.o=!1,this.u=this.B=this.A=this.M=this.F=this.T=this.D=null,this.G=[],this.g=null,this.C=0,this.m=this.v=null,this.X=-1,this.K=!1,this.P=0,this.O=null,this.W=this.L=this.U=this.R=!1,this.h=new ua}function ua(){this.i=null,this.g="",this.h=!1}var ha={},Wr={};function Kr(o,l,h){o.M=1,o.A=Ss(Oe(l)),o.u=h,o.R=!0,da(o,null)}function da(o,l){o.F=Date.now(),bs(o),o.B=Oe(o.A);var h=o.B,m=o.S;Array.isArray(m)||(m=[String(m)]),ba(h.i,"t",m),o.C=0,h=o.j.L,o.h=new ua,o.g=qa(o.j,h?l:null,!o.u),o.P>0&&(o.O=new td(d(o.Y,o,o.g),o.P)),l=o.V,h=o.g,m=o.ba;var I="readystatechange";Array.isArray(I)||(I&&(ea[0]=I.toString()),I=ea);for(let b=0;b<I.length;b++){const k=Qo(h,I[b],m||l.handleEvent,!1,l.h||l);if(!k)break;l.g[k.key]=k}l=o.J?Go(o.J):{},o.u?(o.v||(o.v="POST"),l["Content-Type"]="application/x-www-form-urlencoded",o.g.ea(o.B,o.v,o.u,l)):(o.v="GET",o.g.ea(o.B,o.v,null,l)),Cn(),rd(o.i,o.v,o.B,o.l,o.S,o.u)}st.prototype.ba=function(o){o=o.target;const l=this.O;l&&ot(o)==3?l.j():this.Y(o)},st.prototype.Y=function(o){try{if(o==this.g)e:{const j=ot(this.g),ue=this.g.ya(),X=this.g.ca();if(!(j<3)&&(j!=3||this.g&&(this.h.h||this.g.la()||Da(this.g)))){this.K||j!=4||ue==7||(ue==8||X<=0?Cn(3):Cn(2)),Qr(this);var l=this.g.ca();this.X=l;var h=ld(this);if(this.o=l==200,id(this.i,this.v,this.B,this.l,this.S,j,l),this.o){if(this.U&&!this.L){t:{if(this.g){var m,I=this.g;if((m=I.g?I.g.getResponseHeader("X-HTTP-Initial-Response"):null)&&!y(m)){var b=m;break t}}b=null}if(o=b)Kt(this.i,this.l,o,"Initial handshake response via X-HTTP-Initial-Response"),this.L=!0,Xr(this,o);else{this.o=!1,this.m=3,Ie(12),xt(this),Dn(this);break e}}if(this.R){o=!0;let de;for(;!this.K&&this.C<h.length;)if(de=ud(this,h),de==Wr){j==4&&(this.m=4,Ie(14),o=!1),Kt(this.i,this.l,null,"[Incomplete Response]");break}else if(de==ha){this.m=4,Ie(15),Kt(this.i,this.l,h,"[Invalid Chunk]"),o=!1;break}else Kt(this.i,this.l,de,null),Xr(this,de);if(fa(this)&&this.C!=0&&(this.h.g=this.h.g.slice(this.C),this.C=0),j!=4||h.length!=0||this.h.h||(this.m=1,Ie(16),o=!1),this.o=this.o&&o,!o)Kt(this.i,this.l,h,"[Invalid Chunked Response]"),xt(this),Dn(this);else if(h.length>0&&!this.W){this.W=!0;var k=this.j;k.g==this&&k.aa&&!k.P&&(k.j.info("Great, no buffering proxy detected. Bytes received: "+h.length),ri(k),k.P=!0,Ie(11))}}else Kt(this.i,this.l,h,null),Xr(this,h);j==4&&xt(this),this.o&&!this.K&&(j==4?Ua(this.j,this):(this.o=!1,bs(this)))}else Ad(this.g),l==400&&h.indexOf("Unknown SID")>0?(this.m=3,Ie(12)):(this.m=0,Ie(13)),xt(this),Dn(this)}}}catch{}finally{}};function ld(o){if(!fa(o))return o.g.la();const l=Da(o.g);if(l==="")return"";let h="";const m=l.length,I=ot(o.g)==4;if(!o.h.i){if(typeof TextDecoder>"u")return xt(o),Dn(o),"";o.h.i=new a.TextDecoder}for(let b=0;b<m;b++)o.h.h=!0,h+=o.h.i.decode(l[b],{stream:!(I&&b==m-1)});return l.length=0,o.h.g+=h,o.C=0,o.h.g}function fa(o){return o.g?o.v=="GET"&&o.M!=2&&o.j.Aa:!1}function ud(o,l){var h=o.C,m=l.indexOf(`
`,h);return m==-1?Wr:(h=Number(l.substring(h,m)),isNaN(h)?ha:(m+=1,m+h>l.length?Wr:(l=l.slice(m,m+h),o.C=m+h,l)))}st.prototype.cancel=function(){this.K=!0,xt(this)};function bs(o){o.T=Date.now()+o.H,ma(o,o.H)}function ma(o,l){if(o.D!=null)throw Error("WatchDog timer not null");o.D=Pn(d(o.aa,o),l)}function Qr(o){o.D&&(a.clearTimeout(o.D),o.D=null)}st.prototype.aa=function(){this.D=null;const o=Date.now();o-this.T>=0?(od(this.i,this.B),this.M!=2&&(Cn(),Ie(17)),xt(this),this.m=2,Dn(this)):ma(this,this.T-o)};function Dn(o){o.j.I==0||o.K||Ua(o.j,o)}function xt(o){Qr(o);var l=o.O;l&&typeof l.dispose=="function"&&l.dispose(),o.O=null,ta(o.V),o.g&&(l=o.g,o.g=null,l.abort(),l.dispose())}function Xr(o,l){try{var h=o.j;if(h.I!=0&&(h.g==o||Yr(h.h,o))){if(!o.L&&Yr(h.h,o)&&h.I==3){try{var m=h.Ba.g.parse(l)}catch{m=null}if(Array.isArray(m)&&m.length==3){var I=m;if(I[0]==0){e:if(!h.v){if(h.g)if(h.g.F+3e3<o.F)ks(h),Ps(h);else break e;si(h),Ie(18)}}else h.xa=I[1],0<h.xa-h.K&&I[2]<37500&&h.F&&h.A==0&&!h.C&&(h.C=Pn(d(h.Va,h),6e3));ya(h.h)<=1&&h.ta&&(h.ta=void 0)}else Dt(h,11)}else if((o.L||h.g==o)&&ks(h),!y(l))for(I=h.Ba.g.parse(l),l=0;l<I.length;l++){let X=I[l];const de=X[0];if(!(de<=h.K))if(h.K=de,X=X[1],h.I==2)if(X[0]=="c"){h.M=X[1],h.ba=X[2];const Me=X[3];Me!=null&&(h.ka=Me,h.j.info("VER="+h.ka));const Vt=X[4];Vt!=null&&(h.za=Vt,h.j.info("SVER="+h.za));const at=X[5];at!=null&&typeof at=="number"&&at>0&&(m=1.5*at,h.O=m,h.j.info("backChannelRequestTimeoutMs_="+m)),m=h;const ct=o.g;if(ct){const Vs=ct.g?ct.g.getResponseHeader("X-Client-Wire-Protocol"):null;if(Vs){var b=m.h;b.g||Vs.indexOf("spdy")==-1&&Vs.indexOf("quic")==-1&&Vs.indexOf("h2")==-1||(b.j=b.l,b.g=new Set,b.h&&(Jr(b,b.h),b.h=null))}if(m.G){const ii=ct.g?ct.g.getResponseHeader("X-HTTP-Session-Id"):null;ii&&(m.wa=ii,J(m.J,m.G,ii))}}h.I=3,h.l&&h.l.ra(),h.aa&&(h.T=Date.now()-o.F,h.j.info("Handshake RTT: "+h.T+"ms")),m=h;var k=o;if(m.na=ja(m,m.L?m.ba:null,m.W),k.L){_a(m.h,k);var j=k,ue=m.O;ue&&(j.H=ue),j.D&&(Qr(j),bs(j)),m.g=k}else Ma(m);h.i.length>0&&xs(h)}else X[0]!="stop"&&X[0]!="close"||Dt(h,7);else h.I==3&&(X[0]=="stop"||X[0]=="close"?X[0]=="stop"?Dt(h,7):ni(h):X[0]!="noop"&&h.l&&h.l.qa(X),h.A=0)}}Cn(4)}catch{}}var hd=class{constructor(o,l){this.g=o,this.map=l}};function pa(o){this.l=o||10,a.PerformanceNavigationTiming?(o=a.performance.getEntriesByType("navigation"),o=o.length>0&&(o[0].nextHopProtocol=="hq"||o[0].nextHopProtocol=="h2")):o=!!(a.chrome&&a.chrome.loadTimes&&a.chrome.loadTimes()&&a.chrome.loadTimes().wasFetchedViaSpdy),this.j=o?this.l:1,this.g=null,this.j>1&&(this.g=new Set),this.h=null,this.i=[]}function ga(o){return o.h?!0:o.g?o.g.size>=o.j:!1}function ya(o){return o.h?1:o.g?o.g.size:0}function Yr(o,l){return o.h?o.h==l:o.g?o.g.has(l):!1}function Jr(o,l){o.g?o.g.add(l):o.h=l}function _a(o,l){o.h&&o.h==l?o.h=null:o.g&&o.g.has(l)&&o.g.delete(l)}pa.prototype.cancel=function(){if(this.i=va(this),this.h)this.h.cancel(),this.h=null;else if(this.g&&this.g.size!==0){for(const o of this.g.values())o.cancel();this.g.clear()}};function va(o){if(o.h!=null)return o.i.concat(o.h.G);if(o.g!=null&&o.g.size!==0){let l=o.i;for(const h of o.g.values())l=l.concat(h.G);return l}return S(o.i)}var Ea=RegExp("^(?:([^:/?#.]+):)?(?://(?:([^\\\\/?#]*)@)?([^\\\\/?#]*?)(?::([0-9]+))?(?=[\\\\/?#]|$))?([^?#]+)?(?:\\?([^#]*))?(?:#([\\s\\S]*))?$");function dd(o,l){if(o){o=o.split("&");for(let h=0;h<o.length;h++){const m=o[h].indexOf("=");let I,b=null;m>=0?(I=o[h].substring(0,m),b=o[h].substring(m+1)):I=o[h],l(I,b?decodeURIComponent(b.replace(/\+/g," ")):"")}}}function rt(o){this.g=this.o=this.j="",this.u=null,this.m=this.h="",this.l=!1;let l;o instanceof rt?(this.l=o.l,Vn(this,o.j),this.o=o.o,this.g=o.g,Nn(this,o.u),this.h=o.h,Zr(this,Sa(o.i)),this.m=o.m):o&&(l=String(o).match(Ea))?(this.l=!1,Vn(this,l[1]||"",!0),this.o=Ln(l[2]||""),this.g=Ln(l[3]||"",!0),Nn(this,l[4]),this.h=Ln(l[5]||"",!0),Zr(this,l[6]||"",!0),this.m=Ln(l[7]||"")):(this.l=!1,this.i=new Mn(null,this.l))}rt.prototype.toString=function(){const o=[];var l=this.j;l&&o.push(On(l,wa,!0),":");var h=this.g;return(h||l=="file")&&(o.push("//"),(l=this.o)&&o.push(On(l,wa,!0),"@"),o.push(kn(h).replace(/%25([0-9a-fA-F]{2})/g,"%$1")),h=this.u,h!=null&&o.push(":",String(h))),(h=this.h)&&(this.g&&h.charAt(0)!="/"&&o.push("/"),o.push(On(h,h.charAt(0)=="/"?pd:md,!0))),(h=this.i.toString())&&o.push("?",h),(h=this.m)&&o.push("#",On(h,yd)),o.join("")},rt.prototype.resolve=function(o){const l=Oe(this);let h=!!o.j;h?Vn(l,o.j):h=!!o.o,h?l.o=o.o:h=!!o.g,h?l.g=o.g:h=o.u!=null;var m=o.h;if(h)Nn(l,o.u);else if(h=!!o.h){if(m.charAt(0)!="/")if(this.g&&!this.h)m="/"+m;else{var I=l.h.lastIndexOf("/");I!=-1&&(m=l.h.slice(0,I+1)+m)}if(I=m,I==".."||I==".")m="";else if(I.indexOf("./")!=-1||I.indexOf("/.")!=-1){m=I.lastIndexOf("/",0)==0,I=I.split("/");const b=[];for(let k=0;k<I.length;){const j=I[k++];j=="."?m&&k==I.length&&b.push(""):j==".."?((b.length>1||b.length==1&&b[0]!="")&&b.pop(),m&&k==I.length&&b.push("")):(b.push(j),m=!0)}m=b.join("/")}else m=I}return h?l.h=m:h=o.i.toString()!=="",h?Zr(l,Sa(o.i)):h=!!o.m,h&&(l.m=o.m),l};function Oe(o){return new rt(o)}function Vn(o,l,h){o.j=h?Ln(l,!0):l,o.j&&(o.j=o.j.replace(/:$/,""))}function Nn(o,l){if(l){if(l=Number(l),isNaN(l)||l<0)throw Error("Bad port number "+l);o.u=l}else o.u=null}function Zr(o,l,h){l instanceof Mn?(o.i=l,_d(o.i,o.l)):(h||(l=On(l,gd)),o.i=new Mn(l,o.l))}function J(o,l,h){o.i.set(l,h)}function Ss(o){return J(o,"zx",Math.floor(Math.random()*2147483648).toString(36)+Math.abs(Math.floor(Math.random()*2147483648)^Date.now()).toString(36)),o}function Ln(o,l){return o?l?decodeURI(o.replace(/%25/g,"%2525")):decodeURIComponent(o):""}function On(o,l,h){return typeof o=="string"?(o=encodeURI(o).replace(l,fd),h&&(o=o.replace(/%25([0-9a-fA-F]{2})/g,"%$1")),o):null}function fd(o){return o=o.charCodeAt(0),"%"+(o>>4&15).toString(16)+(o&15).toString(16)}var wa=/[#\/\?@]/g,md=/[#\?:]/g,pd=/[#\?]/g,gd=/[#\?@]/g,yd=/#/g;function Mn(o,l){this.h=this.g=null,this.i=o||null,this.j=!!l}function kt(o){o.g||(o.g=new Map,o.h=0,o.i&&dd(o.i,function(l,h){o.add(decodeURIComponent(l.replace(/\+/g," ")),h)}))}s=Mn.prototype,s.add=function(o,l){kt(this),this.i=null,o=Qt(this,o);let h=this.g.get(o);return h||this.g.set(o,h=[]),h.push(l),this.h+=1,this};function Ta(o,l){kt(o),l=Qt(o,l),o.g.has(l)&&(o.i=null,o.h-=o.g.get(l).length,o.g.delete(l))}function Ia(o,l){return kt(o),l=Qt(o,l),o.g.has(l)}s.forEach=function(o,l){kt(this),this.g.forEach(function(h,m){h.forEach(function(I){o.call(l,I,m,this)},this)},this)};function Aa(o,l){kt(o);let h=[];if(typeof l=="string")Ia(o,l)&&(h=h.concat(o.g.get(Qt(o,l))));else for(o=Array.from(o.g.values()),l=0;l<o.length;l++)h=h.concat(o[l]);return h}s.set=function(o,l){return kt(this),this.i=null,o=Qt(this,o),Ia(this,o)&&(this.h-=this.g.get(o).length),this.g.set(o,[l]),this.h+=1,this},s.get=function(o,l){return o?(o=Aa(this,o),o.length>0?String(o[0]):l):l};function ba(o,l,h){Ta(o,l),h.length>0&&(o.i=null,o.g.set(Qt(o,l),S(h)),o.h+=h.length)}s.toString=function(){if(this.i)return this.i;if(!this.g)return"";const o=[],l=Array.from(this.g.keys());for(let m=0;m<l.length;m++){var h=l[m];const I=kn(h);h=Aa(this,h);for(let b=0;b<h.length;b++){let k=I;h[b]!==""&&(k+="="+kn(h[b])),o.push(k)}}return this.i=o.join("&")};function Sa(o){const l=new Mn;return l.i=o.i,o.g&&(l.g=new Map(o.g),l.h=o.h),l}function Qt(o,l){return l=String(l),o.j&&(l=l.toLowerCase()),l}function _d(o,l){l&&!o.j&&(kt(o),o.i=null,o.g.forEach(function(h,m){const I=m.toLowerCase();m!=I&&(Ta(this,m),ba(this,I,h))},o)),o.j=l}function vd(o,l){const h=new xn;if(a.Image){const m=new Image;m.onload=f(it,h,"TestLoadImage: loaded",!0,l,m),m.onerror=f(it,h,"TestLoadImage: error",!1,l,m),m.onabort=f(it,h,"TestLoadImage: abort",!1,l,m),m.ontimeout=f(it,h,"TestLoadImage: timeout",!1,l,m),a.setTimeout(function(){m.ontimeout&&m.ontimeout()},1e4),m.src=o}else l(!1)}function Ed(o,l){const h=new xn,m=new AbortController,I=setTimeout(()=>{m.abort(),it(h,"TestPingServer: timeout",!1,l)},1e4);fetch(o,{signal:m.signal}).then(b=>{clearTimeout(I),b.ok?it(h,"TestPingServer: ok",!0,l):it(h,"TestPingServer: server error",!1,l)}).catch(()=>{clearTimeout(I),it(h,"TestPingServer: error",!1,l)})}function it(o,l,h,m,I){try{I&&(I.onload=null,I.onerror=null,I.onabort=null,I.ontimeout=null),m(h)}catch{}}function wd(){this.g=new sd}function ei(o){this.i=o.Sb||null,this.h=o.ab||!1}p(ei,na),ei.prototype.g=function(){return new Rs(this.i,this.h)};function Rs(o,l){ye.call(this),this.H=o,this.o=l,this.m=void 0,this.status=this.readyState=0,this.responseType=this.responseText=this.response=this.statusText="",this.onreadystatechange=null,this.A=new Headers,this.h=null,this.F="GET",this.D="",this.g=!1,this.B=this.j=this.l=null,this.v=new AbortController}p(Rs,ye),s=Rs.prototype,s.open=function(o,l){if(this.readyState!=0)throw this.abort(),Error("Error reopening a connection");this.F=o,this.D=l,this.readyState=1,Un(this)},s.send=function(o){if(this.readyState!=1)throw this.abort(),Error("need to call open() first. ");if(this.v.signal.aborted)throw this.abort(),Error("Request was aborted.");this.g=!0;const l={headers:this.A,method:this.F,credentials:this.m,cache:void 0,signal:this.v.signal};o&&(l.body=o),(this.H||a).fetch(new Request(this.D,l)).then(this.Pa.bind(this),this.ga.bind(this))},s.abort=function(){this.response=this.responseText="",this.A=new Headers,this.status=0,this.v.abort(),this.j&&this.j.cancel("Request was aborted.").catch(()=>{}),this.readyState>=1&&this.g&&this.readyState!=4&&(this.g=!1,Fn(this)),this.readyState=0},s.Pa=function(o){if(this.g&&(this.l=o,this.h||(this.status=this.l.status,this.statusText=this.l.statusText,this.h=o.headers,this.readyState=2,Un(this)),this.g&&(this.readyState=3,Un(this),this.g)))if(this.responseType==="arraybuffer")o.arrayBuffer().then(this.Na.bind(this),this.ga.bind(this));else if(typeof a.ReadableStream<"u"&&"body"in o){if(this.j=o.body.getReader(),this.o){if(this.responseType)throw Error('responseType must be empty for "streamBinaryChunks" mode responses.');this.response=[]}else this.response=this.responseText="",this.B=new TextDecoder;Ra(this)}else o.text().then(this.Oa.bind(this),this.ga.bind(this))};function Ra(o){o.j.read().then(o.Ma.bind(o)).catch(o.ga.bind(o))}s.Ma=function(o){if(this.g){if(this.o&&o.value)this.response.push(o.value);else if(!this.o){var l=o.value?o.value:new Uint8Array(0);(l=this.B.decode(l,{stream:!o.done}))&&(this.response=this.responseText+=l)}o.done?Fn(this):Un(this),this.readyState==3&&Ra(this)}},s.Oa=function(o){this.g&&(this.response=this.responseText=o,Fn(this))},s.Na=function(o){this.g&&(this.response=o,Fn(this))},s.ga=function(){this.g&&Fn(this)};function Fn(o){o.readyState=4,o.l=null,o.j=null,o.B=null,Un(o)}s.setRequestHeader=function(o,l){this.A.append(o,l)},s.getResponseHeader=function(o){return this.h&&this.h.get(o.toLowerCase())||""},s.getAllResponseHeaders=function(){if(!this.h)return"";const o=[],l=this.h.entries();for(var h=l.next();!h.done;)h=h.value,o.push(h[0]+": "+h[1]),h=l.next();return o.join(`\r
...
`}),l}function ti(o,l,h){e:{for(m in h){var m=!1;break e}m=!0}m||(h=Ca(h),typeof o=="string"?h!=null&&kn(h):J(o,l,h))}function te(o){ye.call(this),this.headers=new Map,this.L=o||null,this.h=!1,this.g=null,this.D="",this.o=0,this.l="",this.j=this.B=this.v=this.A=!1,this.m=null,this.F="",this.H=!1}p(te,ye);var Td=/^https?$/i,Id=["POST","PUT"];s=te.prototype,s.Fa=function(o){this.H=o},s.ea=function(o,l,h,m){if(this.g)throw Error("[goog.net.XhrIo] Object is active with another request="+this.D+"; newUri="+o);l=l?l.toUpperCase():"GET",this.D=o,this.l="",this.o=0,this.A=!1,this.h=!0,this.g=this.L?this.L.g():la.g(),this.g.onreadystatechange=v(d(this.Ca,this));try{this.B=!0,this.g.open(l,String(o),!0),this.B=!1}catch(b){Pa(this,b);return}if(o=h||"",h=new Map(this.headers),m)if(Object.getPrototypeOf(m)===Object.prototype)for(var I in m)h.set(I,m[I]);else if(typeof m.keys=="function"&&typeof m.get=="function")for(const b of m.keys())h.set(b,m.get(b));else throw Error("Unknown input type for opt_headers: "+String(m));m=Array.from(h.keys()).find(b=>b.toLowerCase()=="content-type"),I=a.FormData&&o instanceof a.FormData,!(Array.prototype.indexOf.call(Id,l,void 0)>=0)||m||I||h.set("Content-Type","application/x-www-form-urlencoded;charset=utf-8");for(const[b,k]of h)this.g.setRequestHeader(b,k);this.F&&(this.g.responseType=this.F),"withCredentials"in this.g&&this.g.withCredentials!==this.H&&(this.g.withCredentials=this.H);try{this.m&&(clearTimeout(this.m),this.m=null),this.v=!0,this.g.send(o),this.v=!1}catch(b){Pa(this,b)}};function Pa(o,l){o.h=!1,o.g&&(o.j=!0,o.g.abort(),o.j=!1),o.l=l,o.o=5,xa(o),Cs(o)}function xa(o){o.A||(o.A=!0,Te(o,"complete"),Te(o,"error"))}s.abort=function(o){this.g&&this.h&&(this.h=!1,this.j=!0,this.g.abort(),this.j=!1,this.o=o||7,Te(this,"complete"),Te(this,"abort"),Cs(this))},s.N=function(){this.g&&(this.h&&(this.h=!1,this.j=!0,this.g.abort(),this.j=!1),Cs(this,!0)),te.Z.N.call(this)},s.Ca=function(){this.u||(this.B||this.v||this.j?ka(this):this.Xa())},s.Xa=function(){ka(this)};function ka(o){if(o.h&&typeof i<"u"){if(o.v&&ot(o)==4)setTimeout(o.Ca.bind(o),0);else if(Te(o,"readystatechange"),ot(o)==4){o.h=!1;try{const b=o.ca();e:switch(b){case 200:case 201:case 202:case 204:case 206:case 304:case 1223:var l=!0;break e;default:l=!1}var h;if(!(h=l)){var m;if(m=b===0){let k=String(o.D).match(Ea)[1]||null;!k&&a.self&&a.self.location&&(k=a.self.location.protocol.slice(0,-1)),m=!Td.test(k?k.toLowerCase():"")}h=m}if(h)Te(o,"complete"),Te(o,"success");else{o.o=6;try{var I=ot(o)>2?o.g.statusText:""}catch{I=""}o.l=I+" ["+o.ca()+"]",xa(o)}}finally{Cs(o)}}}}function Cs(o,l){if(o.g){o.m&&(clearTimeout(o.m),o.m=null);const h=o.g;o.g=null,l||Te(o,"ready");try{h.onreadystatechange=null}catch{}}}s.isActive=function(){return!!this.g};function ot(o){return o.g?o.g.readyState:0}s.ca=function(){try{return ot(this)>2?this.g.status:-1}catch{return-1}},s.la=function(){try{return this.g?this.g.responseText:""}catch{return""}},s.La=function(o){if(this.g){var l=this.g.responseText;return o&&l.indexOf(o)==0&&(l=l.substring(o.length)),nd(l)}};function Da(o){try{if(!o.g)return null;if("response"in o.g)return o.g.response;switch(o.F){case"":case"text":return o.g.responseText;case"arraybuffer":if("mozResponseArrayBuffer"in o.g)return o.g.mozResponseArrayBuffer}return null}catch{return null}}function Ad(o){const l={};o=(o.g&&ot(o)>=2&&o.g.getAllResponseHeaders()||"").split(`\r
`);for(let m=0;m<o.length;m++){if(y(o[m]))continue;var h=cd(o[m]);const I=h[0];if(h=h[1],typeof h!="string")continue;h=h.trim();const b=l[I]||[];l[I]=b,b.push(h)}Xh(l,function(m){return m.join(", ")})}s.ya=function(){return this.o},s.Ha=function(){return typeof this.l=="string"?this.l:String(this.l)};function Bn(o,l,h){return h&&h.internalChannelParams&&h.internalChannelParams[o]||l}function Va(o){this.za=0,this.i=[],this.j=new xn,this.ba=this.na=this.J=this.W=this.g=this.wa=this.G=this.H=this.u=this.U=this.o=null,this.Ya=this.V=0,this.Sa=Bn("failFast",!1,o),this.F=this.C=this.v=this.m=this.l=null,this.X=!0,this.xa=this.K=-1,this.Y=this.A=this.D=0,this.Qa=Bn("baseRetryDelayMs",5e3,o),this.Za=Bn("retryDelaySeedMs",1e4,o),this.Ta=Bn("forwardChannelMaxRetries",2,o),this.va=Bn("forwardChannelRequestTimeoutMs",2e4,o),this.ma=o&&o.xmlHttpFactory||void 0,this.Ua=o&&o.Rb||void 0,this.Aa=o&&o.useFetchStreams||!1,this.O=void 0,this.L=o&&o.supportsCrossDomainXhr||!1,this.M="",this.h=new pa(o&&o.concurrentRequestLimit),this.Ba=new wd,this.S=o&&o.fastHandshake||!1,this.R=o&&o.encodeInitMessageHeaders||!1,this.S&&this.R&&(this.R=!1),this.Ra=o&&o.Pb||!1,o&&o.ua&&this.j.ua(),o&&o.forceLongPolling&&(this.X=!1),this.aa=!this.S&&this.X&&o&&o.detectBufferingProxy||!1,this.ia=void 0,o&&o.longPollingTimeout&&o.longPollingTimeout>0&&(this.ia=o.longPollingTimeout),this.ta=void 0,this.T=0,this.P=!1,this.ja=this.B=null}s=Va.prototype,s.ka=8,s.I=1,s.connect=function(o,l,h,m){Ie(0),this.W=o,this.H=l||{},h&&m!==void 0&&(this.H.OSID=h,this.H.OAID=m),this.F=this.X,this.J=ja(this,null,this.W),xs(this)};function ni(o){if(Na(o),o.I==3){var l=o.V++,h=Oe(o.J);if(J(h,"SID",o.M),J(h,"RID",l),J(h,"TYPE","terminate"),$n(o,h),l=new st(o,o.j,l),l.M=2,l.A=Ss(Oe(h)),h=!1,a.navigator&&a.navigator.sendBeacon)try{h=a.navigator.sendBeacon(l.A.toString(),"")}catch{}!h&&a.Image&&(new Image().src=l.A,h=!0),h||(l.g=qa(l.j,null),l.g.ea(l.A)),l.F=Date.now(),bs(l)}$a(o)}function Ps(o){o.g&&(ri(o),o.g.cancel(),o.g=null)}function Na(o){Ps(o),o.v&&(a.clearTimeout(o.v),o.v=null),ks(o),o.h.cancel(),o.m&&(typeof o.m=="number"&&a.clearTimeout(o.m),o.m=null)}function xs(o){if(!ga(o.h)&&!o.m){o.m=!0;var l=o.Ea;Ce||g(),le||(Ce(),le=!0),w.add(l,o),o.D=0}}function bd(o,l){return ya(o.h)>=o.h.j-(o.m?1:0)?!1:o.m?(o.i=l.G.concat(o.i),!0):o.I==1||o.I==2||o.D>=(o.Sa?0:o.Ta)?!1:(o.m=Pn(d(o.Ea,o,l),Ba(o,o.D)),o.D++,!0)}s.Ea=function(o){if(this.m)if(this.m=null,this.I==1){if(!o){this.V=Math.floor(Math.random()*1e5),o=this.V++;const I=new st(this,this.j,o);let b=this.o;if(this.U&&(b?(b=Go(b),Ko(b,this.U)):b=this.U),this.u!==null||this.R||(I.J=b,b=null),this.S)e:{for(var l=0,h=0;h<this.i.length;h++){t:{var m=this.i[h];if("__data__"in m.map&&(m=m.map.__data__,typeof m=="string")){m=m.length;break t}m=void 0}if(m===void 0)break;if(l+=m,l>4096){l=h;break e}if(l===4096||h===this.i.length-1){l=h+1;break e}}l=1e3}else l=1e3;l=Oa(this,I,l),h=Oe(this.J),J(h,"RID",o),J(h,"CVER",22),this.G&&J(h,"X-HTTP-Session-Id",this.G),$n(this,h),b&&(this.R?l="headers="+kn(Ca(b))+"&"+l:this.u&&ti(h,this.u,b)),Jr(this.h,I),this.Ra&&J(h,"TYPE","init"),this.S?(J(h,"$req",l),J(h,"SID","null"),I.U=!0,Kr(I,h,null)):Kr(I,h,l),this.I=2}}else this.I==3&&(o?La(this,o):this.i.length==0||ga(this.h)||La(this))};function La(o,l){var h;l?h=l.l:h=o.V++;const m=Oe(o.J);J(m,"SID",o.M),J(m,"RID",h),J(m,"AID",o.K),$n(o,m),o.u&&o.o&&ti(m,o.u,o.o),h=new st(o,o.j,h,o.D+1),o.u===null&&(h.J=o.o),l&&(o.i=l.G.concat(o.i)),l=Oa(o,h,1e3),h.H=Math.round(o.va*.5)+Math.round(o.va*.5*Math.random()),Jr(o.h,h),Kr(h,m,l)}function $n(o,l){o.H&&Es(o.H,function(h,m){J(l,m,h)}),o.l&&Es({},function(h,m){J(l,m,h)})}function Oa(o,l,h){h=Math.min(o.i.length,h);const m=o.l?d(o.l.Ka,o.l,o):null;e:{var I=o.i;let j=-1;for(;;){const ue=["count="+h];j==-1?h>0?(j=I[0].g,ue.push("ofs="+j)):j=0:ue.push("ofs="+j);let X=!0;for(let de=0;de<h;de++){var b=I[de].g;const Me=I[de].map;if(b-=j,b<0)j=Math.max(0,I[de].g-100),X=!1;else try{b="req"+b+"_"||"";try{var k=Me instanceof Map?Me:Object.entries(Me);for(const[Vt,at]of k){let ct=at;c(at)&&(ct=qr(at)),ue.push(b+Vt+"="+encodeURIComponent(ct))}}catch(Vt){throw ue.push(b+"type="+encodeURIComponent("_badmap")),Vt}}catch{m&&m(Me)}}if(X){k=ue.join("&");break e}}k=void 0}return o=o.i.splice(0,h),l.G=o,k}function Ma(o){if(!o.g&&!o.v){o.Y=1;var l=o.Da;Ce||g(),le||(Ce(),le=!0),w.add(l,o),o.A=0}}function si(o){return o.g||o.v||o.A>=3?!1:(o.Y++,o.v=Pn(d(o.Da,o),Ba(o,o.A)),o.A++,!0)}s.Da=function(){if(this.v=null,Fa(this),this.aa&&!(this.P||this.g==null||this.T<=0)){var o=4*this.T;this.j.info("BP detection timer enabled: "+o),this.B=Pn(d(this.Wa,this),o)}},s.Wa=function(){this.B&&(this.B=null,this.j.info("BP detection timeout reached."),this.j.info("Buffering proxy detected and switch to long-polling!"),this.F=!1,this.P=!0,Ie(10),Ps(this),Fa(this))};function ri(o){o.B!=null&&(a.clearTimeout(o.B),o.B=null)}function Fa(o){o.g=new st(o,o.j,"rpc",o.Y),o.u===null&&(o.g.J=o.o),o.g.P=0;var l=Oe(o.na);J(l,"RID","rpc"),J(l,"SID",o.M),J(l,"AID",o.K),J(l,"CI",o.F?"0":"1"),!o.F&&o.ia&&J(l,"TO",o.ia),J(l,"TYPE","xmlhttp"),$n(o,l),o.u&&o.o&&ti(l,o.u,o.o),o.O&&(o.g.H=o.O);var h=o.g;o=o.ba,h.M=1,h.A=Ss(Oe(l)),h.u=null,h.R=!0,da(h,o)}s.Va=function(){this.C!=null&&(this.C=null,Ps(this),si(this),Ie(19))};function ks(o){o.C!=null&&(a.clearTimeout(o.C),o.C=null)}function Ua(o,l){var h=null;if(o.g==l){ks(o),ri(o),o.g=null;var m=2}else if(Yr(o.h,l))h=l.G,_a(o.h,l),m=1;else return;if(o.I!=0){if(l.o)if(m==1){h=l.u?l.u.length:0,l=Date.now()-l.F;var I=o.D;m=Is(),Te(m,new aa(m,h)),xs(o)}else Ma(o);else if(I=l.m,I==3||I==0&&l.X>0||!(m==1&&bd(o,l)||m==2&&si(o)))switch(h&&h.length>0&&(l=o.h,l.i=l.i.concat(h)),I){case 1:Dt(o,5);break;case 4:Dt(o,10);break;case 3:Dt(o,6);break;default:Dt(o,2)}}}function Ba(o,l){let h=o.Qa+Math.floor(Math.random()*o.Za);return o.isActive()||(h*=2),h*l}function Dt(o,l){if(o.j.info("Error code "+l),l==2){var h=d(o.bb,o),m=o.Ua;const I=!m;m=new rt(m||"//www.google.com/images/cleardot.gif"),a.location&&a.location.protocol=="http"||Vn(m,"https"),Ss(m),I?vd(m.toString(),h):Ed(m.toString(),h)}else Ie(2);o.I=0,o.l&&o.l.pa(l),$a(o),Na(o)}s.bb=function(o){o?(this.j.info("Successfully pinged google.com"),Ie(2)):(this.j.info("Failed to ping google.com"),Ie(1))};function $a(o){if(o.I=0,o.ja=[],o.l){const l=va(o.h);(l.length!=0||o.i.length!=0)&&(P(o.ja,l),P(o.ja,o.i),o.h.i.length=0,S(o.i),o.i.length=0),o.l.oa()}}function ja(o,l,h){var m=h instanceof rt?Oe(h):new rt(h);if(m.g!="")l&&(m.g=l+"."+m.g),Nn(m,m.u);else{var I=a.location;m=I.protocol,l=l?l+"."+I.hostname:I.hostname,I=+I.port;const b=new rt(null);m&&Vn(b,m),l&&(b.g=l),I&&Nn(b,I),h&&(b.h=h),m=b}return h=o.G,l=o.wa,h&&l&&J(m,h,l),J(m,"VER",o.ka),$n(o,m),m}function qa(o,l,h){if(l&&!o.L)throw Error("Can't create secondary domain capable XhrIo object.");return l=o.Aa&&!o.ma?new te(new ei({ab:h})):new te(o.ma),l.Fa(o.L),l}s.isActive=function(){return!!this.l&&this.l.isActive(this)};function za(){}s=za.prototype,s.ra=function(){},s.qa=function(){},s.pa=function(){},s.oa=function(){},s.isActive=function(){return!0},s.Ka=function(){};function Ds(){}Ds.prototype.g=function(o,l){return new Pe(o,l)};function Pe(o,l){ye.call(this),this.g=new Va(l),this.l=o,this.h=l&&l.messageUrlParams||null,o=l&&l.messageHeaders||null,l&&l.clientProtocolHeaderRequired&&(o?o["X-Client-Protocol"]="webchannel":o={"X-Client-Protocol":"webchannel"}),this.g.o=o,o=l&&l.initMessageHeaders||null,l&&l.messageContentType&&(o?o["X-WebChannel-Content-Type"]=l.messageContentType:o={"X-WebChannel-Content-Type":l.messageContentType}),l&&l.sa&&(o?o["X-WebChannel-Client-Profile"]=l.sa:o={"X-WebChannel-Client-Profile":l.sa}),this.g.U=o,(o=l&&l.Qb)&&!y(o)&&(this.g.u=o),this.A=l&&l.supportsCrossDomainXhr||!1,this.v=l&&l.sendRawJson||!1,(l=l&&l.httpSessionIdParam)&&!y(l)&&(this.g.G=l,o=this.h,o!==null&&l in o&&(o=this.h,l in o&&delete o[l])),this.j=new Xt(this)}p(Pe,ye),Pe.prototype.m=function(){this.g.l=this.j,this.A&&(this.g.L=!0),this.g.connect(this.l,this.h||void 0)},Pe.prototype.close=function(){ni(this.g)},Pe.prototype.o=function(o){var l=this.g;if(typeof o=="string"){var h={};h.__data__=o,o=h}else this.v&&(h={},h.__data__=qr(o),o=h);l.i.push(new hd(l.Ya++,o)),l.I==3&&xs(l)},Pe.prototype.N=function(){this.g.l=null,delete this.j,ni(this.g),delete this.g,Pe.Z.N.call(this)};function Ha(o){zr.call(this),o.__headers__&&(this.headers=o.__headers__,this.statusCode=o.__status__,delete o.__headers__,delete o.__status__);var l=o.__sm__;if(l){e:{for(const h in l){o=h;break e}o=void 0}(this.i=o)&&(o=this.i,l=l!==null&&o in l?l[o]:void 0),this.data=l}else this.data=o}p(Ha,zr);function Ga(){Hr.call(this),this.status=1}p(Ga,Hr);function Xt(o){this.g=o}p(Xt,za),Xt.prototype.ra=function(){Te(this.g,"a")},Xt.prototype.qa=function(o){Te(this.g,new Ha(o))},Xt.prototype.pa=function(o){Te(this.g,new Ga)},Xt.prototype.oa=function(){Te(this.g,"b")},Ds.prototype.createWebChannel=Ds.prototype.g,Pe.prototype.send=Pe.prototype.o,Pe.prototype.open=Pe.prototype.m,Pe.prototype.close=Pe.prototype.close,ql=function(){return new Ds},jl=function(){return Is()},$l=Pt,Pi={jb:0,mb:1,nb:2,Hb:3,Mb:4,Jb:5,Kb:6,Ib:7,Gb:8,Lb:9,PROXY:10,NOPROXY:11,Eb:12,Ab:13,Bb:14,zb:15,Cb:16,Db:17,fb:18,eb:19,gb:20},As.NO_ERROR=0,As.TIMEOUT=8,As.HTTP_ERROR=6,$s=As,ca.COMPLETE="complete",Bl=ca,sa.EventType=Rn,Rn.OPEN="a",Rn.CLOSE="b",Rn.ERROR="c",Rn.MESSAGE="d",ye.prototype.listen=ye.prototype.J,jn=sa,te.prototype.listenOnce=te.prototype.K,te.prototype.getLastError=te.prototype.Ha,te.prototype.getLastErrorCode=te.prototype.ya,te.prototype.getStatus=te.prototype.ca,te.prototype.getResponseJson=te.prototype.La,te.prototype.getResponseText=te.prototype.la,te.prototype.send=te.prototype.ea,te.prototype.setWithCredentials=te.prototype.Fa,Ul=te}).apply(typeof Ls<"u"?Ls:typeof self<"u"?self:typeof window<"u"?window:{});const oc="@firebase/firestore",ac="4.9.2";/**
 * @license
 * Copyright 2017 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */const $t=new Xi("@firebase/firestore");function Jt(){return $t.logLevel}function N(s,...e){if($t.logLevel<=q.DEBUG){const t=e.map(Zi);$t.debug(`Firestore (${vn}): ${s}`,...t)}}function Ye(s,...e){if($t.logLevel<=q.ERROR){const t=e.map(Zi);$t.error(`Firestore (${vn}): ${s}`,...t)}}function un(s,...e){if($t.logLevel<=q.WARN){const t=e.map(Zi);$t.warn(`Firestore (${vn}): ${s}`,...t)}}function Zi(s){if(typeof s=="string")return s;try{/**
* @license
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */class eo{static newId(){const e="ABCDEFGHIJKLMNOPQRSTUVWXYZabcdefghijklmnopqrstuvwxyz0123456789",t=62*Math.floor(4.129032258064516);let n="";for(;n.length<20;){const r=Sm(40);for(let i=0;i<r.length;++i)n.length<20&&r[i]<t&&(n+=e.charAt(r[i]%62))}return n}}function z(s,e){return s<e?-1:s>e?1:0}function xi(s,e){const t=Math.min(s.length,e.length);for(let n=0;n<t;n++){const r=s.charAt(n),i=e.charAt(n);if(r!==i)return hi(r)===hi(i)?z(r,i):hi(r)?1:-1}return z(s.length,e.length)}const Rm=55296,Cm=57343;function hi(s){const e=s.charCodeAt(0);return e>=Rm&&e<=Cm}function hn(s,e,t){return s.length===e.length&&s.every((n,r)=>t(n,e[r]))}/**
 * @license
 * Copyright 2017 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */const es=-1;function km(s,e){const t=s.toTimestamp().seconds,n=s.toTimestamp().nanoseconds+1,r=F.fromTimestamp(n===1e9?new Z(t+1,0):new Z(t,n));return new Et(r,L.empty(),e)}function Dm(s){return new Et(s.readTime,s.key,es)}class Et{constructor(e,t,n){this.readTime=e,this.documentKey=t,this.largestBatchId=n}static min(){return new Et(F.min(),L.empty(),es)}static max(){return new Et(F.max(),L.empty(),es)}}function Vm(s,e){let t=s.readTime.compareTo(e.readTime);return t!==0?t:(t=L.comparator(s.documentKey,e.documentKey),t!==0?t:z(s.largestBatchId,e.largestBatchId))}/**
 * @license
 * Copyright 2020 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */class ke{constructor(e){this.fields=e,e.sort(pe.comparator)}static empty(){return new ke([])}unionWith(e){let t=new he(pe.comparator);for(const n of this.fields)t=t.add(n);for(const n of e)t=t.add(n);return new ke(t.toArray())}covers(e){for(const t of this.fields)if(t.isPrefixOf(e))return!0;return!1}isEqual(e){return hn(this.fields,e.fields,(t,n)=>t.isEqual(n))}}/**
 * @license
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */const Ip=new _t([4294967295,4294967295],0);function xc(s){const e=Tp().encode(s),t=new Fl;return t.update(e),new Uint8Array(t.digest())}function kc(s){const e=new DataView(s.buffer),t=e.getUint32(0,!0),n=e.getUint32(4,!0),r=e.getUint32(8,!0),i=e.getUint32(12,!0);return[new _t([t,n],0),new _t([r,i],0)]}class uo{constructor(e,t,n){if(this.bitmap=e,this.padding=t,this.hashCount=n,t<0||t>=8)throw new zn(`Invalid padding: ${t}`);if(n<0)throw new zn(`Invalid hash count: ${n}`);if(e.length>0&&this.hashCount===0)throw new zn(`Invalid hash count: ${n}`);if(e.length===0&&t!==0)throw new zn(`Invalid padding when bitmap length is 0: ${t}`);this.ge=8*e.length-t,this.pe=_t.fromNumber(this.ge)}ye(e,t,n){let r=e.add(t.multiply(_t.fromNumber(n)));return r.compare(Ip)===1&&(r=new _t([r.getBits(0),r.getBits(1)],0)),r.modulo(this.pe).toNumber()}we(e){return!!(this.bitmap[Math.floor(e/8)]&1<<e%8)}mightContain(e){if(this.ge===0)return!1;const t=xc(e),[n,r]=kc(t);for(let i=0;i<this.hashCount;i++){const a=this.ye(n,r,i);if(!this.we(a))return!1}return!0}static create(e,t,n){const r=e%8==0?0:8-e%8,i=new Uint8Array(Math.ceil(e/8)),a=new uo(i,r,t);return n.forEach(c=>a.insert(c)),a}insert(e){if(this.ge===0)return;const t=xc(e),[n,r]=kc(t);for(let i=0;i<this.hashCount;i++){const a=this.ye(n,r,i);this.Se(a)}}Se(e){const t=Math.floor(e/8),n=e%8;this.bitmap[t]|=1<<n}}class zn extends Error{constructor(){super(...arguments),this.name="BloomFilterError"}}/**
 * @license
 * Copyright 2017 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */class Hs{constructor(e,t,n,r){this.be=e,this.removedTargetIds=t,this.key=n,this.De=r}}class Au{constructor(e,t){this.targetId=e,this.Ce=t}}class bu{constructor(e,t,n=ge.EMPTY_BYTE_STRING,r=null){this.state=e,this.targetIds=t,this.resumeToken=n,this.cause=r}}class Dc{constructor(){this.ve=0,this.Fe=Vc(),this.Me=ge.EMPTY_BYTE_STRING,this.xe=!1,this.Oe=!0}get current(){return this.xe}get resumeToken(){return this.Me}get Ne(){return this.ve!==0}get Be(){return this.Oe}Le(e){e.approximateByteSize()>0&&(this.Oe=!0,this.Me=e)}ke(){let e=H(),t=H(),n=H();return this.Fe.forEach((r,i)=>{switch(i){case 0:e=e.add(r);break;case 2:t=t.add(r);break;case 1:n=n.add(r);break;default:O(38017,{changeType:i})}}),new ds(this.Me,this.xe,e,t,n)}qe(){this.Oe=!1,this.Fe=Vc()}Qe(e,t){this.Oe=!0,this.Fe=this.Fe.insert(e,t)}$e(e){this.Oe=!0,this.Fe=this.Fe.remove(e)}Ue(){this.ve+=1}Ke(){this.ve-=1,Q(this.ve>=0,3241,{ve:this.ve})}We(){this.Oe=!0,this.xe=!0}}class Ap{constructor(e){this.Ge=e,this.ze=new Map,this.je=Ze(),this.Je=Fs(),this.He=Fs(),this.Ye=new ee(z)}Ze(e){for(const t of e.be)e.De&&e.De.isFoundDocument()?this.Xe(t,e.De):this.et(t,e.key,e.De);for(const t of e.removedTargetIds)this.et(t,e.key,e.De)}tt(e){this.forEachTarget(e,t=>{const n=this.nt(t);switch(e.state){case 0:this.rt(t)&&n.Le(e.resumeToken);break;case 1:n.Ke(),n.Ne||n.qe(),n.Le(e.resumeToken);break;case 2:n.Ke(),n.Ne||this.removeTarget(t);break;case 3:this.rt(t)&&(n.We(),n.Le(e.resumeToken));break;case 4:this.rt(t)&&(this.it(t),n.Le(e.resumeToken));break;default:O(56790,{state:e.state})}})}forEachTarget(e,t){e.targetIds.length>0?e.targetIds.forEach(t):this.ze.forEach((n,r)=>{this.rt(r)&&t(r)})}st(e){const t=e.targetId,n=e.Ce.count,r=this.ot(t);if(r){const i=r.target;if(Ni(i))if(n===0){const a=new L(i.path);this.et(t,a,Ee.newNoDocument(a,F.min()))}else Q(n===1,20013,{expectedCount:n});else{const a=this._t(t);if(a!==n){const c=this.ut(e),u=c?this.ct(c,e,a):1;if(u!==0){this.it(t);const d=u===2?"TargetPurposeExistenceFilterMismatchBloom":"TargetPurposeExistenceFilterMismatch";this.Ye=this.Ye.insert(t,d)}}}}}ut(e){const t=e.Ce.unchangedNames;if(!t||!t.bits)return null;const{bits:{bitmap:n="",padding:r=0},hashCount:i=0}=t;let a,c;try{a=Tt(n).toUint8Array()}catch(u){if(u instanceof Xl)return un("Decoding the base64 bloom filter in existence filter failed ("+u.message+"); ignoring the bloom filter and falling back to full re-query."),null;throw u}try{c=new uo(a,r,i)}catch(u){return un(u instanceof zn?"BloomFilter error: ":"Applying bloom filter failed: ",u),null}return c.ge===0?null:c}ct(e,t,n){return t.Ce.count===n-this.Pt(e,t.targetId)?0:2}Pt(e,t){const n=this.Ge.getRemoteKeysForTarget(t);let r=0;return n.forEach(i=>{const a=this.Ge.ht(),c=`projects/${a.projectId}/databases/${a.database}/documents/${i.path.canonicalString()}`;e.mightContain(c)||(this.et(t,i,null),r++)}),r}Tt(e){const t=new Map;this.ze.forEach((i,a)=>{const c=this.ot(a);if(c){if(i.current&&Ni(c.target)){const u=new L(c.target.path);this.It(u).has(a)||this.Et(a,u)||this.et(a,u,Ee.newNoDocument(u,e))}i.Be&&(t.set(a,i.ke()),i.qe())}});let n=H();this.He.forEach((i,a)=>{let c=!0;a.forEachWhile(u=>{const d=this.ot(u);return!d||d.purpose==="TargetPurposeLimboResolution"||(c=!1,!1)}),c&&(n=n.add(i))}),this.je.forEach((i,a)=>a.setReadTime(e));const r=new br(e,t,this.Ye,this.je,n);return this.je=Ze(),this.Je=Fs(),this.He=Fs(),this.Ye=new ee(z),r}Xe(e,t){if(!this.rt(e))return;const n=this.Et(e,t.key)?2:0;this.nt(e).Qe(t.key,n),this.je=this.je.insert(t.key,t),this.Je=this.Je.insert(t.key,this.It(t.key).add(e)),this.He=this.He.insert(t.key,this.dt(t.key).add(e))}et(e,t,n){if(!this.rt(e))return;const r=this.nt(e);this.Et(e,t)?r.Qe(t,1):r.$e(t),this.He=this.He.insert(t,this.dt(t).delete(e)),this.He=this.He.insert(t,this.dt(t).add(e)),n&&(this.je=this.je.insert(t,n))}removeTarget(e){this.ze.delete(e)}_t(e){const t=this.nt(e).ke();return this.Ge.getRemoteKeysForTarget(e).size+t.addedDocuments.size-t.removedDocuments.size}Ue(e){this.nt(e).Ue()}nt(e){let t=this.ze.get(e);return t||(t=new Dc,this.ze.set(e,t)),t}dt(e){let t=this.He.get(e);return t||(t=new he(z),this.He=this.He.insert(e,t)),t}It(e){let t=this.Je.get(e);return t||(t=new he(z),this.Je=this.Je.insert(e,t)),t}rt(e){const t=this.ot(e)!==null;return t||N("WatchChangeAggregator","Detected inactive target",e),t}ot(e){const t=this.ze.get(e);return t&&t.Ne?null:this.Ge.At(e)}it(e){this.ze.set(e,new Dc),this.Ge.getRemoteKeysForTarget(e).forEach(t=>{this.et(e,t,null)})}Et(e,t){return this.Ge.getRemoteKeysForTarget(e).has(t)}}function Fs(){return new ee(L.comparator)}function Vc(){return new ee(L.comparator)}const bp={asc:"ASCENDING",desc:"DESCENDING"},Sp={"<":"LESS_THAN","<=":"LESS_THAN_OR_EQUAL",">":"GREATER_THAN",">=":"GREATER_THAN_OR_EQUAL","==":"EQUAL","!=":"NOT_EQUAL","array-contains":"ARRAY_CONTAINS",in:"IN","not-in":"NOT_IN","array-contains-any":"ARRAY_CONTAINS_ANY"},Rp={and:"AND",or:"OR"};class Cp{constructor(e,t){this.databaseId=e,this.useProto3Json=t}}function Mi(s,e){return s.useProto3Json||vr(e)?e:{value:e}}function ir(s,e){return s.useProto3Json?`${new Date(1e3*e.seconds).toISOString().replace(/\.\d*/,"").replace("Z","")}.${("000000000"+e.nanoseconds).slice(-9)}Z`:{seconds:""+e.seconds,nanos:e.nanoseconds}}function Su(s,e){return s.useProto3Json?e.toBase64():e.toUint8Array()}function Pp(s,e){return ir(s,e.toTimestamp())}function $e(s){return Q(!!s,49232),F.fromTimestamp(function(t){const n=wt(t);return new Z(n.seconds,n.nanos)}(s))}function ho(s,e){return Fi(s,e).canonicalString()}function Fi(s,e){const t=function(r){return new Y(["projects",r.projectId,"databases",r.database])}(s).child("documents");return e===void 0?t:t.child(e)}function Ru(s){const e=Y.fromString(s);return Q(Du(e),10190,{key:e.toString()}),e}function Ui(s,e){return ho(s.databaseId,e.path)}function di(s,e){const t=Ru(e);if(t.get(1)!==s.databaseId.projectId)throw new V(R.INVALID_ARGUMENT,"Tried to deserialize key from different project: "+t.get(1)+" vs "+s.databaseId.projectId);if(t.get(3)!==s.databaseId.database)throw new V(R.INVALID_ARGUMENT,"Tried to deserialize key from different database: "+t.get(3)+" vs "+s.databaseId.database);return new L(Pu(t))}function Cu(s,e){return ho(s.databaseId,e)}function xp(s){const e=Ru(s);return e.length===4?Y.emptyPath():Pu(e)}function Bi(s){return new Y(["projects",s.databaseId.projectId,"databases",s.databaseId.database]).canonicalString()}function Pu(s){return Q(s.length>4&&s.get(4)==="documents",29091,{key:s.toString()}),s.popFirst(5)}function Nc(s,e,t){return{name:Ui(s,e),fields:t.value.mapValue.fields}}function kp(s,e){let t;if("targetChange"in e){e.targetChange;const n=function(d){return d==="NO_CHANGE"?0:d==="ADD"?1:d==="REMOVE"?2:d==="CURRENT"?3:d==="RESET"?4:O(39313,{state:d})}(e.targetChange.targetChangeType||"NO_CHANGE"),r=e.targetChange.targetIds||[],i=function(d,f){return d.useProto3Json?(Q(f===void 0||typeof f=="string",58123),ge.fromBase64String(f||"")):(Q(f===void 0||f instanceof Buffer||f instanceof Uint8Array,16193),ge.fromUint8Array(f||new Uint8Array))}(s,e.targetChange.resumeToken),a=e.targetChange.cause,c=a&&function(d){const f=d.code===void 0?R.UNKNOWN:Iu(d.code);return new V(f,d.message||"")}(a);t=new bu(n,r,i,c||null)}else if("documentChange"in e){e.documentChange;const n=e.documentChange;n.document,n.document.name,n.document.updateTime;const r=di(s,n.document.name),i=$e(n.document.updateTime),a=n.document.createTime?$e(n.document.createTime):F.min(),c=new Re({mapValue:{fields:n.document.fields}}),u=Ee.newFoundDocument(r,i,a,c),d=n.targetIds||[],f=n.removedTargetIds||[];t=new Hs(d,f,u.key,u)}else if("documentDelete"in e){e.documentDelete;const n=e.documentDelete;n.document;const r=di(s,n.document),i=n.readTime?$e(n.readTime):F.min(),a=Ee.newNoDocument(r,i),c=n.removedTargetIds||[];t=new Hs([],c,a.key,a)}else if("documentRemove"in e){e.documentRemove;const n=e.documentRemove;n.document;const r=di(s,n.document),i=n.removedTargetIds||[];t=new Hs([],i,r,null)}else{if(!("filter"in e))return O(11601,{Rt:e});{e.filter;const n=e.filter;n.targetId;const{count:r=0,unchangedNames:i}=n,a=new Ep(r,i),c=n.targetId;t=new Au(c,a)}}return t}function Dp(s,e){let t;if(e instanceof hs)t={update:Nc(s,e.key,e.value)};else if(e instanceof co)t={delete:Ui(s,e.key)};else if(e instanceof Rt)t={update:Nc(s,e.key,e.data),updateMask:$p(e.fieldMask)};else{if(!(e instanceof yp))return O(16599,{Vt:e.type});t={verify:Ui(s,e.key)}}return e.fieldTransforms.length>0&&(t.updateTransforms=e.fieldTransforms.map(n=>function(i,a){const c=a.transform;if(c instanceof sr)return{fieldPath:a.field.canonicalString(),setToServerValue:"REQUEST_TIME"};if(c instanceof is)return{fieldPath:a.field.canonicalString(),appendMissingElements:{values:c.elements}};if(c instanceof os)return{fieldPath:a.field.canonicalString(),removeAllFromArray:{values:c.elements}};if(c instanceof rr)return{fieldPath:a.field.canonicalString(),increment:c.Ae};throw O(20930,{transform:a.transform})}(0,n))),e.precondition.isNone||(t.currentDocument=function(r,i){return i.updateTime!==void 0?{updateTime:Pp(r,i.updateTime)}:i.exists!==void 0?{exists:i.exists}:O(27497)}(s,e.precondition)),t}function Vp(s,e){return s&&s.length>0?(Q(e!==void 0,14353),s.map(t=>function(r,i){let a=r.updateTime?$e(r.updateTime):$e(i);return a.isEqual(F.min())&&(a=$e(i)),new mp(a,r.transformResults||[])}(t,e))):[]}function Np(s,e){return{documents:[Cu(s,e.path)]}}function Lp(s,e){const t={structuredQuery:{}},n=e.path;let r;e.collectionGroup!==null?(r=n,t.structuredQuery.from=[{collectionId:e.collectionGroup,allDescendants:!0}]):(r=n.popLast(),t.structuredQuery.from=[{collectionId:n.lastSegment()}]),t.parent=Cu(s,r);const i=function(d){if(d.length!==0)return ku(Le.create(d,"and"))}(e.filters);i&&(t.structuredQuery.where=i);const a=function(d){if(d.length!==0)return d.map(f=>function(v){return{field:en(v.field),direction:Fp(v.dir)}}(f))}(e.orderBy);a&&(t.structuredQuery.orderBy=a);const c=Mi(s,e.limit);return c!==null&&(t.structuredQuery.limit=c),e.startAt&&(t.structuredQuery.startAt=function(d){return{before:d.inclusive,values:d.position}}(e.startAt)),e.endAt&&(t.structuredQuery.endAt=function(d){return{before:!d.inclusive,values:d.position}}(e.endAt)),{ft:t,parent:r}}function Op(s){let e=xp(s.parent);const t=s.structuredQuery,n=t.from?t.from.length:0;let r=null;if(n>0){Q(n===1,65062);const f=t.from[0];f.allDescendants?r=f.collectionId:e=e.child(f.collectionId)}let i=[];t.where&&(i=function(p){const v=xu(p);return v instanceof Le&&ou(v)?v.getFilters():[v]}(t.where));let a=[];t.orderBy&&(a=function(p){return p.map(v=>function(P){return new rs(tn(P.field),function(x){switch(x){case"ASCENDING":return"asc";case"DESCENDING":return"desc";default:return}}(P.direction))}(v))}(t.orderBy));let c=null;t.limit&&(c=function(p){let v;return v=typeof p=="object"?p.value:p,vr(v)?null:v}(t.limit));let u=null;t.startAt&&(u=function(p){const v=!!p.before,S=p.values||[];return new nr(S,v)}(t.startAt));let d=null;return t.endAt&&(d=function(p){const v=!p.before,S=p.values||[];return new nr(S,v)}(t.endAt)),tp(e,r,a,i,c,"F",u,d)}function Mp(s,e){const t=function(r){switch(r){case"TargetPurposeListen":return null;case"TargetPurposeExistenceFilterMismatch":return"existence-filter-mismatch";case"TargetPurposeExistenceFilterMismatchBloom":return"existence-filter-mismatch-bloom";case"TargetPurposeLimboResolution":return"limbo-document";default:return O(28987,{purpose:r})}}(e.purpose);return t==null?null:{"goog-listen-tags":t}}function xu(s){return s.unaryFilter!==void 0?function(t){switch(t.unaryFilter.op){case"IS_NAN":const n=tn(t.unaryFilter.field);return oe.create(n,"==",{doubleValue:NaN});case"IS_NULL":const r=tn(t.unaryFilter.field);return oe.create(r,"==",{nullValue:"NULL_VALUE"});case"IS_NOT_NAN":const i=tn(t.unaryFilter.field);return oe.create(i,"!=",{doubleValue:NaN});case"IS_NOT_NULL":const a=tn(t.unaryFilter.field);return oe.create(a,"!=",{nullValue:"NULL_VALUE"});case"OPERATOR_UNSPECIFIED":return O(61313);default:return O(60726)}}(s):s.fieldFilter!==void 0?function(t){return oe.create(tn(t.fieldFilter.field),function(r){switch(r){case"EQUAL":return"==";case"NOT_EQUAL":return"!=";case"GREATER_THAN":return">";case"GREATER_THAN_OR_EQUAL":return">=";case"LESS_THAN":return"<";case"LESS_THAN_OR_EQUAL":return"<=";case"ARRAY_CONTAINS":return"array-contains";case"IN":return"in";case"NOT_IN":return"not-in";case"ARRAY_CONTAINS_ANY":return"array-contains-any";case"OPERATOR_UNSPECIFIED":return O(58110);default:return O(50506)}}(t.fieldFilter.op),t.fieldFilter.value)}(s):s.compositeFilter!==void 0?function(t){return Le.create(t.compositeFilter.filters.map(n=>xu(n)),function(r){switch(r){case"AND":return"and";case"OR":return"or";default:return O(1026)}}(t.compositeFilter.op))}(s):O(30097,{filter:s})}function Fp(s){return bp[s]}function Up(s){return Sp[s]}function Bp(s){return Rp[s]}function en(s){return{fieldPath:s.canonicalString()}}function tn(s){return pe.fromServerFormat(s.fieldPath)}function ku(s){return s instanceof oe?function(t){if(t.op==="=="){if(wc(t.value))return{unaryFilter:{field:en(t.field),op:"IS_NAN"}};if(Ec(t.value))return{unaryFilter:{field:en(t.field),op:"IS_NULL"}}}else if(t.op==="!="){if(wc(t.value))return{unaryFilter:{field:en(t.field),op:"IS_NOT_NAN"}};if(Ec(t.value))return{unaryFilter:{field:en(t.field),op:"IS_NOT_NULL"}}}return{fieldFilter:{field:en(t.field),op:Up(t.op),value:t.value}}}(s):s instanceof Le?function(t){const n=t.getFilters().map(r=>ku(r));return n.length===1?n[0]:{compositeFilter:{op:Bp(t.op),filters:n}}}(s):O(54877,{filter:s})}function $p(s){const e=[];return s.fields.forEach(t=>e.push(t.canonicalString())),{fieldPaths:e}}function Du(s){return s.length>=4&&s.get(0)==="projects"&&s.get(2)==="databases"}/**
 * @license
 * Copyright 2017 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */class Yp{constructor(){this.changes=new Ht(e=>e.toString(),(e,t)=>e.isEqual(t)),this.changesApplied=!1}addEntry(e){this.assertNotApplied(),this.changes.set(e.key,e)}removeEntry(e,t){this.assertNotApplied(),this.changes.set(e,Ee.newInvalidDocument(e).setReadTime(t))}getEntry(e,t){this.assertNotApplied();const n=this.changes.get(t);return n!==void 0?C.resolve(n):this.getFromCache(e,t)}getEntries(e,t){return this.getAllFromCache(e,t)}apply(e){return this.assertNotApplied(),this.changesApplied=!0,this.applyChanges(e)}assertNotApplied(){}}/**
 * @license
 * Copyright 2017 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */class Zp{constructor(e,t,n,r){this.remoteDocumentCache=e,this.mutationQueue=t,this.documentOverlayCache=n,this.indexManager=r}getDocument(e,t){let n=null;return this.documentOverlayCache.getOverlay(e,t).next(r=>(n=r,this.remoteDocumentCache.getEntry(e,t))).next(r=>(n!==null&&Yn(n.mutation,r,ke.empty(),Z.now()),r))}getDocuments(e,t){return this.remoteDocumentCache.getEntries(e,t).next(n=>this.getLocalViewOfDocuments(e,n,H()).next(()=>n))}getLocalViewOfDocuments(e,t,n=H()){const r=Ot();return this.populateOverlays(e,r,t).next(()=>this.computeViews(e,t,r,n).next(i=>{let a=qn();return i.forEach((c,u)=>{a=a.insert(c,u.overlayedDocument)}),a}))}getOverlayedDocuments(e,t){const n=Ot();return this.populateOverlays(e,n,t).next(()=>this.computeViews(e,t,n,H()))}populateOverlays(e,t,n){const r=[];return n.forEach(i=>{t.has(i)||r.push(i)}),this.documentOverlayCache.getOverlays(e,r).next(i=>{i.forEach((a,c)=>{t.set(a,c)})})}computeViews(e,t,n,r){let i=Ze();const a=Xn(),c=function(){return Xn()}();return t.forEach((u,d)=>{const f=n.get(d.key);r.has(d.key)&&(f===void 0||f.mutation instanceof Rt)?i=i.insert(d.key,d):f!==void 0?(a.set(d.key,f.mutation.getFieldMask()),Yn(f.mutation,d,f.mutation.getFieldMask(),Z.now())):a.set(d.key,ke.empty())}),this.recalculateAndSaveOverlays(e,i).next(u=>(u.forEach((d,f)=>a.set(d,f)),t.forEach((d,f)=>c.set(d,new Jp(f,a.get(d)??null))),c))}recalculateAndSaveOverlays(e,t){const n=Xn();let r=new ee((a,c)=>a-c),i=H();return this.mutationQueue.getAllMutationBatchesAffectingDocumentKeys(e,t).next(a=>{for(const c of a)c.keys().forEach(u=>{const d=t.get(u);if(d===null)return;let f=n.get(u)||ke.empty();f=c.applyToLocalView(d,f),n.set(u,f);const p=(r.get(c.batchId)||H()).add(u);r=r.insert(c.batchId,p)})}).next(()=>{const a=[],c=r.getReverseIterator();for(;c.hasNext();){const u=c.getNext(),d=u.key,f=u.value,p=pu();f.forEach(v=>{if(!i.has(v)){const S=wu(t.get(v),n.get(v));S!==null&&p.set(v,S),i=i.add(v)}}),a.push(this.documentOverlayCache.saveOverlays(e,d,p))}return C.waitFor(a)}).next(()=>n)}recalculateAndSaveOverlaysForDocumentKeys(e,t){return this.remoteDocumentCache.getEntries(e,t).next(n=>this.recalculateAndSaveOverlays(e,n))}getDocumentsMatchingQuery(e,t,n,r){return function(a){return L.isDocumentKey(a.path)&&a.collectionGroup===null&&a.filters.length===0}(t)?this.getDocumentsMatchingDocumentQuery(e,t.path):uu(t)?this.getDocumentsMatchingCollectionGroupQuery(e,t,n,r):this.getDocumentsMatchingCollectionQuery(e,t,n,r)}getNextDocuments(e,t,n,r){return this.remoteDocumentCache.getAllFromCollectionGroup(e,t,n,r).next(i=>{const a=r-i.size>0?this.documentOverlayCache.getOverlaysForCollectionGroup(e,t,n.largestBatchId,r-i.size):C.resolve(Ot());let c=es,u=i;return a.next(d=>C.forEach(d,(f,p)=>(c<p.largestBatchId&&(c=p.largestBatchId),i.get(f)?C.resolve():this.remoteDocumentCache.getEntry(e,f).next(v=>{u=u.insert(f,v)}))).next(()=>this.populateOverlays(e,d,i)).next(()=>this.computeViews(e,u,d,H())).next(f=>({batchId:c,changes:mu(f)})))})}getDocumentsMatchingDocumentQuery(e,t){return this.getDocument(e,new L(t)).next(n=>{let r=qn();return n.isFoundDocument()&&(r=r.insert(n.key,n)),r})}getDocumentsMatchingCollectionGroupQuery(e,t,n,r){const i=t.collectionGroup;let a=qn();return this.indexManager.getCollectionParents(e,i).next(c=>C.forEach(c,u=>{const d=function(p,v){return new Tn(v,null,p.explicitOrderBy.slice(),p.filters.slice(),p.limit,p.limitType,p.startAt,p.endAt)}(t,u.child(i));return this.getDocumentsMatchingCollectionQuery(e,d,n,r).next(f=>{f.forEach((p,v)=>{a=a.insert(p,v)})})}).next(()=>a))}getDocumentsMatchingCollectionQuery(e,t,n,r){let i;return this.documentOverlayCache.getOverlaysForCollection(e,t.path,n.largestBatchId).next(a=>(i=a,this.remoteDocumentCache.getDocumentsMatchingQuery(e,t,n,i,r))).next(a=>{i.forEach((u,d)=>{const f=d.getKey();a.get(f)===null&&(a=a.insert(f,Ee.newInvalidDocument(f)))});let c=qn();return a.forEach((u,d)=>{const f=i.get(u);f!==void 0&&Yn(f.mutation,d,ke.empty(),Z.now()),Tr(t,d)&&(c=c.insert(u,d))}),c})}}/**
 * @license
 * Copyright 2020 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */class po{constructor(e,t,n,r){this.targetId=e,this.fromCache=t,this.Es=n,this.ds=r}static As(e,t){let n=H(),r=H();for(const i of t.docChanges)switch(i.type){case 0:n=n.add(i.doc.key);break;case 1:r=r.add(i.doc.key)}return new po(e,t.fromCache,n,r)}}/**
 * @license
 * Copyright 2023 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */class lg{constructor(){this.Rs=!1,this.Vs=!1,this.fs=100,this.gs=function(){return tf()?8:Om(we())>0?6:4}()}initialize(e,t){this.ps=e,this.indexManager=t,this.Rs=!0}getDocumentsMatchingQuery(e,t,n,r){const i={result:null};return this.ys(e,t).next(a=>{i.result=a}).next(()=>{if(!i.result)return this.ws(e,t,r,n).next(a=>{i.result=a})}).next(()=>{if(i.result)return;const a=new cg;return this.Ss(e,t,a).next(c=>{if(i.result=c,this.Vs)return this.bs(e,t,a,c.size)})}).next(()=>i.result)}bs(e,t,n,r){return n.documentReadCount<this.fs?(Jt()<=q.DEBUG&&N("QueryEngine","SDK will not create cache indexes for query:",Zt(t),"since it only creates cache indexes for collection contains","more than or equal to",this.fs,"documents"),C.resolve()):(Jt()<=q.DEBUG&&N("QueryEngine","Query:",Zt(t),"scans",n.documentReadCount,"local documents and returns",r,"documents as results."),n.documentReadCount>this.gs*r?(Jt()<=q.DEBUG&&N("QueryEngine","The SDK decides to create cache indexes for query:",Zt(t),"as using cache indexes may help improve performance."),this.indexManager.createTargetIndexes(e,Be(t))):C.resolve())}ys(e,t){if(bc(t))return C.resolve(null);let n=Be(t);return this.indexManager.getIndexType(e,n).next(r=>r===0?null:(t.limit!==null&&r===1&&(t=Oi(t,null,"F"),n=Be(t)),this.indexManager.getDocumentsMatchingTarget(e,n).next(i=>{const a=H(...i);return this.ps.getDocuments(e,a).next(c=>this.indexManager.getMinOffset(e,n).next(u=>{const d=this.Ds(t,c);return this.Cs(t,d,a,u.readTime)?this.ys(e,Oi(t,null,"F")):this.vs(e,d,t,u)}))})))}ws(e,t,n,r){return bc(t)||r.isEqual(F.min())?C.resolve(null):this.ps.getDocuments(e,n).next(i=>{const a=this.Ds(t,i);return this.Cs(t,a,n,r)?C.resolve(null):(Jt()<=q.DEBUG&&N("QueryEngine","Re-using previous result from %s to execute query: %s",r.toString(),Zt(t)),this.vs(e,a,t,km(r,es)).next(c=>c))})}Ds(e,t){let n=new he(du(e));return t.forEach((r,i)=>{Tr(e,i)&&(n=n.add(i))}),n}Cs(e,t,n,r){if(e.limit===null)return!1;if(n.size!==t.size)return!0;const i=e.limitType==="F"?t.last():t.first();return!!i&&(i.hasPendingWrites||i.version.compareTo(r)>0)}Ss(e,t,n){return Jt()<=q.DEBUG&&N("QueryEngine","Using full collection scan to execute query:",Zt(t)),this.ps.getDocumentsMatchingQuery(e,t,Et.min(),n)}vs(e,t,n,r){return this.ps.getDocumentsMatchingQuery(e,n,r).next(i=>(t.forEach(a=>{i=i.insert(a.key,a)}),i))}}/**
 * @license
 * Copyright 2020 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */const jt="RemoteStore";class xg{constructor(e,t,n,r,i){this.localStore=e,this.datastore=t,this.asyncQueue=n,this.remoteSyncer={},this.Ta=[],this.Ia=new Map,this.Ea=new Set,this.da=[],this.Aa=i,this.Aa.Oo(a=>{n.enqueueAndForget(async()=>{Gt(this)&&(N(jt,"Restarting streams for network reachability change."),await async function(u){const d=U(u);d.Ea.add(4),await fs(d),d.Ra.set("Unknown"),d.Ea.delete(4),await Rr(d)}(this))})}),this.Ra=new Pg(n,r)}}async function Rr(s){if(Gt(s))for(const e of s.da)await e(!0)}async function fs(s){for(const e of s.da)await e(!1)}function Uu(s,e){const t=U(s);t.Ia.has(e.targetId)||(t.Ia.set(e.targetId,e),Eo(t)?vo(t):In(t).O_()&&_o(t,e))}function yo(s,e){const t=U(s),n=In(t);t.Ia.delete(e),n.O_()&&Bu(t,e),t.Ia.size===0&&(n.O_()?n.L_():Gt(t)&&t.Ra.set("Unknown"))}function _o(s,e){if(s.Va.Ue(e.targetId),e.resumeToken.approximateByteSize()>0||e.snapshotVersion.compareTo(F.min())>0){const t=s.remoteSyncer.getRemoteKeysForTarget(e.targetId).size;e=e.withExpectedCount(t)}In(s).Y_(e)}function Bu(s,e){s.Va.Ue(e),In(s).Z_(e)}function vo(s){s.Va=new Ap({getRemoteKeysForTarget:e=>s.remoteSyncer.getRemoteKeysForTarget(e),At:e=>s.Ia.get(e)||null,ht:()=>s.datastore.serializer.databaseId}),In(s).start(),s.Ra.ua()}function Eo(s){return Gt(s)&&!In(s).x_()&&s.Ia.size>0}function Gt(s){return U(s).Ea.size===0}function $u(s){s.Va=void 0}async function kg(s){s.Ra.set("Online")}async function Dg(s){s.Ia.forEach((e,t)=>{_o(s,e)})}async function Vg(s,e){$u(s),Eo(s)?(s.Ra.ha(e),vo(s)):s.Ra.set("Unknown")}async function Ng(s,e,t){if(s.Ra.set("Online"),e instanceof bu&&e.state===2&&e.cause)try{await async function(r,i){const a=i.cause;for(const c of i.targetIds)r.Ia.has(c)&&(await r.remoteSyncer.rejectListen(c,a),r.Ia.delete(c),r.Va.removeTarget(c))}(s,e)}catch(n){N(jt,"Failed to remove targets %s: %s ",e.targetIds.join(","),n),await ar(s,n)}else if(e instanceof Hs?s.Va.Ze(e):e instanceof Au?s.Va.st(e):s.Va.tt(e),!t.isEqual(F.min()))try{const n=await Ou(s.localStore);t.compareTo(n)>=0&&await function(i,a){const c=i.Va.Tt(a);return c.targetChanges.forEach((u,d)=>{if(u.resumeToken.approximateByteSize()>0){const f=i.Ia.get(d);f&&i.Ia.set(d,f.withResumeToken(u.resumeToken,a))}}),c.targetMismatches.forEach((u,d)=>{const f=i.Ia.get(u);if(!f)return;i.Ia.set(u,f.withResumeToken(ge.EMPTY_BYTE_STRING,f.snapshotVersion)),Bu(i,u);const p=new mt(f.target,u,d,f.sequenceNumber);_o(i,p)}),i.remoteSyncer.applyRemoteEvent(c)}(s,t)}catch(n){N(jt,"Failed to raise snapshot:",n),await ar(s,n)}}async function ar(s,e,t){if(!wn(e))throw e;s.Ea.add(1),await fs(s),s.Ra.set("Offline"),t||(t=()=>Ou(s.localStore)),s.asyncQueue.enqueueRetryable(async()=>{N(jt,"Retrying IndexedDB access"),await t(),s.Ea.delete(1),await Rr(s)})}function ju(s,e){return e().catch(t=>ar(s,t,e))}async function Cr(s){const e=U(s),t=At(e);let n=e.Ta.length>0?e.Ta[e.Ta.length-1].batchId:to;for(;Lg(e);)try{const r=await gg(e.localStore,n);if(r===null){e.Ta.length===0&&t.L_();break}n=r.batchId,Og(e,r)}catch(r){await ar(e,r)}qu(e)&&zu(e)}function Lg(s){return Gt(s)&&s.Ta.length<10}function Og(s,e){s.Ta.push(e);const t=At(s);t.O_()&&t.X_&&t.ea(e.mutations)}function qu(s){return Gt(s)&&!At(s).x_()&&s.Ta.length>0}function zu(s){At(s).start()}async function Mg(s){At(s).ra()}async function Fg(s){const e=At(s);for(const t of s.Ta)e.ea(t.mutations)}async function Ug(s,e,t){const n=s.Ta.shift(),r=lo.from(n,e,t);await ju(s,()=>s.remoteSyncer.applySuccessfulWrite(r)),await Cr(s)}async function Bg(s,e){e&&At(s).X_&&await async function(n,r){if(function(a){return wp(a)&&a!==R.ABORTED}(r.code)){const i=n.Ta.shift();At(n).B_(),await ju(n,()=>n.remoteSyncer.rejectFailedWrite(i.batchId,r)),await Cr(n)}}(s,e),qu(s)&&zu(s)}async function qc(s,e){const t=U(s);t.asyncQueue.verifyOperationInProgress(),N(jt,"RemoteStore received new credentials");const n=Gt(t);t.Ea.add(3),await fs(t),n&&t.Ra.set("Unknown"),await t.remoteSyncer.handleCredentialChange(e),t.Ea.delete(3),await Rr(t)}async function $g(s,e){const t=U(s);e?(t.Ea.delete(2),await Rr(t)):e||(t.Ea.add(2),await fs(t),t.Ra.set("Unknown"))}function In(s){return s.ma||(s.ma=function(t,n,r){const i=U(t);return i.sa(),new bg(n,i.connection,i.authCredentials,i.appCheckCredentials,i.serializer,r)}(s.datastore,s.asyncQueue,{Xo:kg.bind(null,s),t_:Dg.bind(null,s),r_:Vg.bind(null,s),H_:Ng.bind(null,s)}),s.da.push(async e=>{e?(s.ma.B_(),Eo(s)?vo(s):s.Ra.set("Unknown")):(await s.ma.stop(),$u(s))})),s.ma}function At(s){return s.fa||(s.fa=function(t,n,r){const i=U(t);return i.sa(),new Sg(n,i.connection,i.authCredentials,i.appCheckCredentials,i.serializer,r)}(s.datastore,s.asyncQueue,{Xo:()=>Promise.resolve(),t_:Mg.bind(null,s),r_:Bg.bind(null,s),ta:Fg.bind(null,s),na:Ug.bind(null,s)}),s.da.push(async e=>{e?(s.fa.B_(),await Cr(s)):(await s.fa.stop(),s.Ta.length>0&&(N(jt,`Stopping write stream with ${s.Ta.length} pending writes`),s.Ta=[]))})),s.fa}/**
 * @license
 * Copyright 2017 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */class De{constructor(e){this._byteString=e}static fromBase64String(e){try{return new De(ge.fromBase64String(e))}catch(t){throw new V(R.INVALID_ARGUMENT,"Failed to construct data from Base64 string: "+t)}}static fromUint8Array(e){return new De(ge.fromUint8Array(e))}toBase64(){return this._byteString.toBase64()}toUint8Array(){return this._byteString.toUint8Array()}toString(){return"Bytes(base64: "+this.toBase64()+")"}isEqual(e){return this._byteString.isEqual(e._byteString)}toJSON(){return{type:De._jsonSchemaVersion,bytes:this.toBase64()}}static fromJSON(e){if(us(e,De._jsonSchema))return De.fromBase64String(e.bytes)}}De._jsonSchemaVersion="firestore/bytes/1.0",De._jsonSchema={type:ae("string",De._jsonSchemaVersion),bytes:ae("string")};/**
 * @license
 * Copyright 2020 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */class dh{constructor(e,t,n,r,i){this._firestore=e,this._userDataWriter=t,this._key=n,this._document=r,this._converter=i}get id(){return this._key.path.lastSegment()}get ref(){return new ce(this._firestore,this._converter,this._key)}exists(){return this._document!==null}data(){if(this._document){if(this._converter){const e=new Sy(this._firestore,this._userDataWriter,this._key,this._document,null);return this._converter.fromFirestore(e)}return this._userDataWriter.convertValue(this._document.data.value)}}get(e){if(this._document){const t=this._document.data.field(Dr("DocumentSnapshot.get",e));if(t!==null)return this._userDataWriter.convertValue(t)}}}class Sy extends dh{data(){return super.data()}}function Dr(s,e){return typeof e=="string"?ko(s,e):e instanceof xr?e._internalPath:e._delegate._internalPath}/**
 * @license
 * Copyright 2020 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */const ur=new Xi("@firebase/auth");function Uy(s,...e){ur.logLevel<=q.WARN&&ur.warn(`Auth (${_n}): ${s}`,...e)}function Ws(s,...e){ur.logLevel<=q.ERROR&&ur.error(`Auth (${_n}): ${s}`,...e)}/**
 * @license
 * Copyright 2020 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */function ul(s){const e=s.toLowerCase();if(e.includes("opera/")||e.includes("opr/")||e.includes("opios/"))return"Opera";if(Rh(e))return"IEMobile";if(e.includes("msie")||e.includes("trident/"))return"IE";if(e.includes("edge/"))return"Edge";if(Ah(e))return"Firefox";if(e.includes("silk/"))return"Silk";if(Ph(e))return"Blackberry";if(xh(e))return"Webos";if(bh(e))return"Safari";if((e.includes("chrome/")||Sh(e))&&!e.includes("edge/"))return"Chrome";if(Ch(e))return"Android";{const t=/([a-zA-Z\d\.]+)\/[a-zA-Z\d\.]*$/,n=s.match(t);if((n==null?void 0:n.length)===2)return n[1]}return"Other"}function Ah(s=we()){return/firefox\//i.test(s)}function bh(s=we()){const e=s.toLowerCase();return e.includes("safari/")&&!e.includes("chrome/")&&!e.includes("crios/")&&!e.includes("android")}function Sh(s=we()){return/crios\//i.test(s)}function Rh(s=we()){return/iemobile/i.test(s)}function Ch(s=we()){return/android/i.test(s)}function Ph(s=we()){return/blackberry/i.test(s)}function xh(s=we()){return/webos/i.test(s)}function Bo(s=we()){return/iphone|ipad|ipod/i.test(s)||/macintosh/i.test(s)&&/mobile/i.test(s)}function n_(s=we()){var e;return Bo(s)&&!!((e=window.navigator)!=null&&e.standalone)}function s_(){return ef()&&document.documentMode===10}function kh(s=we()){return Bo(s)||Ch(s)||xh(s)||Ph(s)||/windows phone/i.test(s)||Rh(s)}/**
 * @license
 * Copyright 2020 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */function Dh(s,e=[]){let t;switch(s){case"Browser":t=ul(we());break;case"Worker":t=`${ul(we())}-${s}`;break;default:t=s}const n=e.length?e.join(","):"FirebaseCore-web";return`${t}/JsCore/${_n}/${n}`}/**
 * @license
 * Copyright 2022 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */function $h(){return typeof He().WorkerGlobalScope<"u"&&typeof He().importScripts=="function"}async function x_(){if(!(navigator!=null&&navigator.serviceWorker))return null;try{return(await navigator.serviceWorker.ready).active}catch{return null}}function k_(){var s;return((s=navigator==null?void 0:navigator.serviceWorker)==null?void 0:s.controller)||null}function D_(){return $h()?self:null}/**
 * @license
 * Copyright 2019 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 */const kv=5*60,Dv=Pl("authIdTokenMaxAge")||kv;let Tl=null;const Vv=s=>async e=>{const t=e&&await e.getIdTokenResult(),n=t&&(new Date().getTime()-Date.parse(t.issuedAtTime))/1e3;if(n&&n>Dv)return;const r=t==null?void 0:t.token;Tl!==r&&(Tl=r,await fetch(s,{method:r?"POST":"DELETE",headers:r?{Authorization:`Bearer ${r}`}:{}}))};function Nv(s=Ll()){const e=Ji(s,"auth");if(e.isInitialized())return e.getImmediate();const t=f_(s,{popupRedirectResolver:Rv,persistence:[F_,S_,Bh]}),n=Pl("authTokenSyncURL");if(n&&typeof isSecureContext=="boolean"&&isSecureContext){const i=new URL(n,location.origin);if(location.origin===i.origin){const a=Vv(i.toString());I_(t,a,()=>a(t.currentUser)),T_(t,c=>a(c))}}const r=Rl("auth");return r&&p_(t,`http://${r}`),t}function Lv(){var s;return((s=document.getElementsByTagName("head"))==null?void 0:s[0])??document}l_({loadJS(s){return new Promise((e,t)=>{const n=document.createElement("script");n.setAttribute("src",s),n.onload=e,n.onerror=r=>{const i=ze("internal-error");i.customData=r,t(i)},n.type="text/javascript",n.charset="UTF-8",Lv().appendChild(n)})},gapiScript:"https://apis.google.com/js/api.js",recaptchaV2Script:"https://www.google.com/recaptcha/api.js",recaptchaEnterpriseScript:"https://www.google.com/recaptcha/enterprise.js?render="});xv("Browser");const zt={apiKey:"AIzaSyAYy5QZzuXAoTGu2NVO6wAx1Q3tXMqO8SI",authDomain:"splitwiseclone-d9135.firebaseapp.com",projectId:"splitwiseclone-d9135",storageBucket:"splitwiseclone-d9135.firebasestorage.app",messagingSenderId:"1067457595825",appId:"1:1067457595825:web:54d33ba82260f11ef39590"},Ho=Nl(zt),Gn=gy(Ho);Nv(Ho);console.log("🔥🔥🔥 FIREBASE CONFIG COMPREHENSIVE DEBUG 🔥🔥🔥");console.log("🔥 Raw firebaseConfig object:",zt);console.log("🔥 Project ID:",zt.projectId);console.log("🔥 Auth Domain:",zt.authDomain);var Il;console.log("🔥 API Key (masked):",((Il=zt.apiKey)==null?void 0:Il.substring(0,10))+"...");console.log("🔥 Environment variables check:");console.log("🔥 - VITE_FIREBASE_PROJECT_ID:","splitwiseclone-d9135");console.log("🔥 - VITE_FIREBASE_API_KEY exists:",!0);console.log("🔥 - VITE_FIREBASE_AUTH_DOMAIN:","splitwiseclone-d9135.firebaseapp.com");zt.projectId==="demo-project"?(console.log("⚠️⚠️⚠️ WARNING: Using demo Firebase config! This will NOT work with real data."),console.log("⚠️ All Firebase calls will fail. Set environment variables!")):console.log("✅ Using real Firebase config for project:",zt.projectId);console.log("✅ FIREBASE-ONLY MODE ACTIVATED ✅");console.log("🔥 Firebase app object:",Ho);console.log("🔥 Firestore db object:",Gn);Ly(()=>Promise.resolve().then(()=>Ov),void 0,import.meta.url).then(s=>{console.log("🔥 Testing Firebase connection..."),s.firebaseService.getUsers().then(e=>console.log("🔥 Firebase works! Users found:",e.length)).catch(e=>console.error("🔥 Firebase connection failed:",e))}).catch(s=>console.error("🔥 Failed to load FirebaseService:",s));class Wh{constructor(){K(this,"usersCollection",gi(Gn,"user"));K(this,"expensesCollection",gi(Gn,"expenses"));K(this,"settlementsCollection",gi(Gn,"settlements"));console.log("🔥🔥🔥 FirebaseService constructor called"),console.log("🔥 Database object:",Gn),console.log("🔥 Users collection:",this.usersCollection),console.log("🔥 Expenses collection:",this.expensesCollection),console.log("🔥 Settlements collection:",this.settlementsCollection),console.log("🔥 FirebaseService initialized successfully")}async getUsers(){try{return(await Yt(this.usersCollection)).docs.map(t=>{var r;const n=t.data();return{id:t.id,name:n.name,username:n.username,avatar:n.avatar,role:n.isAdmin===!0?"admin":n.role||"user",createdAt:((r=n.createdAt)==null?void 0:r.toDate())||new Date,isActive:n.isActive===!0}})}catch(e){throw console.error("Error getting users:",e),e}}async getUserByUsername(e){var t;try{console.log("🔥 FirebaseService: Querying Firestore for username:",e),console.log("🔥 FirebaseService: Collection name:","user"),console.log("🔥 FirebaseService: Query field:","username");const n=yi(this.usersCollection,nl("username","==",e)),r=await Yt(n);console.log("🔥 FirebaseService: Query result - empty:",r.empty,"size:",r.size),console.log("🔥 FirebaseService: Query result - empty:",r.empty,"size:",r.size);const i=await Yt(this.usersCollection);if(console.log("🔥 FirebaseService: ALL DOCUMENTS in collection:",i.size),i.forEach(d=>{const f=d.data();console.log("🔥 FirebaseService: Document:",d.id,"username:",f.username,"isActive:",f.isActive)}),r.empty?console.log("🔥 FirebaseService: No documents found with query"):(console.log("🔥 FirebaseService: Found documents with query:"),r.forEach(d=>{console.log("🔥 FirebaseService: Query result doc:",d.id,d.data())})),r.empty)return console.log("🔥 FirebaseService: No user found with username:",e),null;const a=r.docs[0],c=a.data();console.log("🔥 FirebaseService: Raw user data from Firestore:",c),console.log("🔥🔥🔥 CRITICAL DEBUG 🔥🔥🔥"),console.log("🔥 RAW userData.isActive:",c.isActive),console.log("🔥 RAW userData.isActive TYPE:",typeof c.isActive),console.log("🔥 RAW userData.isActive === true:",c.isActive===!0),console.log("🔥 RAW userData.isActive === false:",c.isActive===!1),c.isActive===!1&&alert("🔥 FIREBASE RAW DATA SHOWS isActive = FALSE for user: "+c.username);const u={id:a.id,name:c.name,username:c.username,avatar:c.avatar,role:c.isAdmin===!0?"admin":c.role||"user",createdAt:((t=c.createdAt)==null?void 0:t.toDate())||new Date,isActive:c.isActive===!0,password:c.password};return console.log("🔥 FirebaseService: Processed user:",u),console.log("🔥 FirebaseService: Password field exists:",!!u.password),u}catch(n){throw console.error("🔥 FirebaseService: Error getting user by username:",n),n}}async createUser(e){try{return{id:(await wi(this.usersCollection,{...e,createdAt:new Date})).id,...e,createdAt:new Date}}catch(t){throw console.error("Error creating user:",t),t}}async updateUser(e,t){var n,r;try{const i=Lt(this.usersCollection,e);await vi(i,t);const a=await _i(i);return{id:a.id,...a.data(),createdAt:((r=(n=a.data())==null?void 0:n.createdAt)==null?void 0:r.toDate())||new Date}}catch(i){throw console.error("Error updating user:",i),i}}async deleteUser(e){try{const t=Lt(this.usersCollection,e);await Ei(t)}catch(t){throw console.error("Error deleting user:",t),t}}async getExpenses(){try{const e=yi(this.expensesCollection,Cy("date","desc"));return(await Yt(e)).docs.map(n=>{var r;return{id:n.id,...n.data(),date:((r=n.data().date)==null?void 0:r.toDate())||new Date}})}catch(e){throw console.error("Error getting expenses:",e),e}}async createExpense(e){try{console.log("🔥🔥🔥 FirebaseService: createExpense called with:",e),console.log("🔥 FirebaseService: Collection name:","expenses"),console.log("🔥 FirebaseService: About to call addDoc...");const t={description:e.description||"Expense",amount:e.amount||0,currency:e.currency||"VND",paidBy:e.paidBy||"",splitBetween:Array.isArray(e.splitBetween)?e.splitBetween:[],splitType:e.splitType||"equal",category:e.category||"other",date:new Date(e.date)};Object.keys(t).forEach(i=>{t[i]===void 0&&delete t[i]}),console.log("🔥 FirebaseService: Original data:",e),console.log("🔥 FirebaseService: Clean data:",t),console.log("🔥 FirebaseService: Clean data keys:",Object.keys(t));const n=await wi(this.expensesCollection,t);console.log("🔥 FirebaseService: addDoc successful, docRef.id:",n.id);const r={id:n.id,...e};return console.log("🔥 FirebaseService: Returning expense:",r),r}catch(t){throw console.error("❌ FirebaseService: Error creating expense:",t),t}}async deleteExpense(e){let n;for(let r=1;r<=3;r++)try{console.log(`🔥🔥🔥 FirebaseService: deleteExpense attempt ${r}/3`),console.log("🔥 Expense ID to delete:",e),console.log("🔥 Collection:","expenses");const i=Lt(this.expensesCollection,e);if(console.log("🔥 Document reference created:",i),!(await _i(i)).exists()){console.log("⚠️ Document không tồn tại, có thể đã bị xóa:",e);return}console.log("🔥 Document exists, proceeding to delete..."),console.log("🔥 About to call deleteDoc..."),await Ei(i),console.log(`✅ FirebaseService: Expense deleted successfully on attempt ${r}!`);return}catch(i){n=i,console.error(`❌ FirebaseService: Delete attempt ${r} failed:`,i),r<3&&(console.log(`🔄 Retrying in ${r*1e3}ms...`),await new Promise(a=>setTimeout(a,r*1e3)))}throw console.error("❌❌❌ FirebaseService: All delete attempts failed"),console.error("❌ Final error:",n),n}async updateExpense(e,t){try{console.log("🔥🔥🔥 FirebaseService: updateExpense called"),console.log("🔥 Expense ID:",e),console.log("🔥 Full expenseData:",t),console.log("🔥 splitBetween array:",t.splitBetween);const n=Lt(this.expensesCollection,e),r={description:t.description,amount:t.amount,currency:t.currency,paidBy:t.paidBy,splitBetween:t.splitBetween,category:t.category,date:t.date,splitType:t.splitType};console.log("🔥 Data to send to Firebase:",r),console.log("🔥 splitBetween data:",r.splitBetween),await vi(n,r),console.log("✅ FirebaseService: Expense updated successfully!")}catch(n){throw console.error("❌ FirebaseService: Error updating expense:",n),n}}async authenticateUser(e,t){var n;try{console.log("🔥🔥🔥 AUTHENTICATION ATTEMPT 🔥🔥🔥"),console.log("🔥 FirebaseService: authenticateUser called with:",{username:e,password:t}),console.log("🔥 FirebaseService: Checking RAW Firebase data directly...");const r=yi(this.usersCollection,nl("username","==",e)),i=await Yt(r);if(i.empty)return console.log("🔥 FirebaseService: No user found with username:",e),null;const a=i.docs[0],c=a.data();if(console.log("🔥🔥🔥 RAW FIREBASE DATA 🔥🔥🔥"),console.log("🔥 RAW rawUserData:",c),console.log("🔥 RAW rawUserData.isActive:",c.isActive),console.log("🔥 RAW rawUserData.isActive TYPE:",typeof c.isActive),console.log("🔥 RAW rawUserData.password:",c.password),c.password!==t)return console.log("🔥 FirebaseService: Password MISMATCH"),null;if(console.log("🔥 FirebaseService: Password match SUCCESS"),c.isActive!==!0)throw console.error("🚫🚫🚫 FIREBASE RAW DATA SHOWS USER INACTIVE 🚫🚫🚫"),console.error("� RAW isActive value:",c.isActive),console.error("🚫 RAW isActive === true:",c.isActive===!0),alert("🚫 TÀI KHOẢN BỊ VÔ HIỆU HÓA - Firebase data: "+c.isActive),new Error("Tài khoản đã bị vô hiệu hóa. Vui lòng liên hệ quản trị viên.");console.log("🔥 FirebaseService: RAW Firebase confirms user is active, proceeding...");const u={id:a.id,name:c.name,username:c.username,avatar:c.avatar,role:c.isAdmin===!0?"admin":"user",createdAt:((n=c.createdAt)==null?void 0:n.toDate())||new Date,isActive:c.isActive};if(u.isActive!==!0)throw console.error("🚨🚨🚨 PARANOID CHECK: About to return user with isActive !== true 🚨🚨🚨"),alert("🚨 PARANOID: Blocking return of inactive user: "+u.isActive),new Error("PARANOID CHECK: Cannot return inactive user");return u}catch(r){throw console.error("🔥 FirebaseService: Error authenticating user:",r),r}}async saveSettlement(e){try{console.log("🔥 FirebaseService: Saving settlement to Firestore..."),console.log("🔥 Settlement:",e);const t={from:e.from,to:e.to,amount:e.amount,description:e.description||"",isSettled:e.isSettled,settledAt:e.settledAt||null,createdAt:e.createdAt,relatedExpenses:e.relatedExpenses||[]};console.log("🔥 Clean settlement data:",t),console.log("🔥 About to call addDoc...");const n=await wi(this.settlementsCollection,t);console.log("🔥 ✅ SUCCESS! Settlement saved with ID:",n.id),console.log("🔥 Document reference:",n),console.log("🔥 Attempting to verify document was saved...");const r=await _i(n);r.exists()?console.log("🔥 ✅ VERIFIED! Document exists:",r.data()):console.log("🔥 ❌ WARNING: Document not found after save!")}catch(t){throw console.error("❌❌❌ FirebaseService: CRITICAL ERROR saving settlement:"),console.error("❌ Error type:",typeof t),console.error("❌ Error message:",t instanceof Error?t.message:t),console.error("❌ Full error object:",t),console.error("❌ Stack trace:",t instanceof Error?t.stack:"No stack"),t}}async getSettlements(){try{return(await Yt(this.settlementsCollection)).docs.map(t=>{var r,i;const n=t.data();return{id:t.id,from:n.from,to:n.to,amount:n.amount,description:n.description||"",isSettled:n.isSettled||!1,settledAt:((r=n.settledAt)==null?void 0:r.toDate())||null,createdAt:((i=n.createdAt)==null?void 0:i.toDate())||new Date,relatedExpenses:n.relatedExpenses||[]}})}catch(e){throw console.error("Error getting settlements:",e),e}}async updateSettlementStatus(e,t){try{const n=Lt(this.settlementsCollection,e),r={isSettled:t};t?r.settledAt=new Date:r.settledAt=null,await vi(n,r),console.log("✅ Settlement status updated successfully")}catch(n){throw console.error("Error updating settlement status:",n),n}}async deleteSettlement(e){try{const t=Lt(this.settlementsCollection,e);await Ei(t),console.log("✅ Settlement deleted successfully:",e)}catch(t){throw console.error("Error deleting settlement:",t),t}}}const xe=new Wh,Ov=Object.freeze(Object.defineProperty({__proto__:null,FirebaseService:Wh,firebaseService:xe},Symbol.toStringTag,{value:"Module"}));class Mv{constructor(){console.log("🔥 AuthService: Initialized with Firebase-only mode")}async login(e){var t,n,r;try{console.log("🚀 AuthService: Starting Firebase-only login"),console.log("🔥🔥🔥 NUCLEAR DIRECT FIREBASE CHECK 🔥🔥🔥");const i=await xe.getUserByUsername(e.username);if(i&&(console.log("🔥 Direct Firebase check - Raw isActive:",i.isActive),i.isActive!==!0))throw console.error("🚫🚫🚫 NUCLEAR BLOCK AT LOGIN START 🚫🚫🚫"),window.NUCLEAR_BLOCKED_AT_START=!0,alert("🚫 NUCLEAR BLOCK: User inactive at start - "+i.isActive),new Error("User blocked at login start - isActive: "+i.isActive);const a=await xe.authenticateUser(e.username,e.password);if(!a)throw new Error("Invalid credentials");if(console.log("🔥 User from Firebase:",a),console.log("🔥 User role:",a.role),console.log("🔥 User isAdmin:",a.isAdmin),console.log("🔥🔥🔥 AUTHSERVICE NUCLEAR CHECK 🔥🔥🔥"),console.log("🔥 AuthService: user.isActive:",a.isActive),console.log("🔥 AuthService: user.isActive type:",typeof a.isActive),window.LAST_LOGIN_ATTEMPT={username:e.username,isActive:a.isActive,timestamp:Date.now()},a.isActive!==!0)throw console.error("🚫🚫🚫 AUTHSERVICE BLOCKS LOGIN - USER NOT ACTIVE 🚫🚫🚫"),window.BLOCKED_BY_AUTHSERVICE=!0,alert("🚫 AUTHSERVICE BLOCK: isActive = "+a.isActive),new Error("Tài khoản đã bị vô hiệu hóa trong AuthService.");const c={isAuthenticated:!0,currentUser:{id:a.id,name:a.name,username:a.username,role:a.isAdmin===!0?"admin":a.role||"user",createdAt:new Date(a.createdAt||Date.now()),isActive:a.isActive,avatar:a.avatar},token:this.generateToken()};if(((t=c.currentUser)==null?void 0:t.isActive)!==!0)throw console.error("🚨🚨🚨 FINAL FAIL-SAFE TRIGGERED 🚨🚨🚨"),console.error("🚨 AuthState has isActive:",(n=c.currentUser)==null?void 0:n.isActive),window.FINAL_FAILSAFE_TRIGGERED=!0,alert("🚨 FINAL FAIL-SAFE: Blocking login with isActive = "+((r=c.currentUser)==null?void 0:r.isActive)),new Error("FINAL FAIL-SAFE: User not active in final auth state.");return console.log("🔥 Final auth state:",c),c}catch(i){throw new Error(i instanceof Error?i.message:"Login failed")}}logout(){}getCurrentAuth(){return{isAuthenticated:!1,currentUser:null}}async createUser(e){try{const t=await xe.createUser({name:e.name,username:e.username,role:"user",isActive:!0,createdAt:new Date,password:e.password,isAdmin:!1});return{id:t.id,name:t.name,username:t.username,role:"user",createdAt:t.createdAt,isActive:!0}}catch(t){throw new Error(t instanceof Error?t.message:"Failed to create user in Firebase")}}async getAllUsers(){try{return(await xe.getUsers()).map(t=>({...t,role:t.isAdmin?"admin":"user"}))}catch(e){throw console.error("Failed to fetch users from Firebase:",e),e}}async updateUser(e,t){try{const n={...t,isAdmin:t.role==="admin"};delete n.role,console.log("🔥 AuthService: Updating user via Firebase:",e,n);const r=await xe.updateUser(e,n);return console.log("🔥 AuthService: User updated successfully via Firebase:",r),r}catch(n){throw new Error(n instanceof Error?n.message:"Failed to update user")}}async deleteUser(e){try{console.log("🔥 AuthService: Deleting user via Firebase:",e),await xe.deleteUser(e),console.log("🔥 AuthService: User deleted successfully from Firebase")}catch(t){throw console.error("🔥 AuthService: Failed to delete user:",t),new Error(t instanceof Error?t.message:"Failed to delete user from Firebase")}}generateToken(){return`token_${Date.now()}_${Math.random().toString(36).substr(2,9)}`}isAdmin(e){return(e==null?void 0:e.role)==="admin"}}console.log("🚀🚀🚀 NUCLEAR VERSION v5.0.0-NO-DELETE 🚀🚀🚀");console.log("🚀 MAIN.TS LOADED SUCCESSFULLY");console.log("🚀 Date:",new Date().toISOString());document.title="Splitwise Clone v5.0.0-NO-DELETE";console.log("=== FIREBASE ONLY MODE - TÍNH NĂNG XÓA ĐÃ BỊ GỠ BỎ ===");console.log("🔥 Build timestamp:",new Date().toISOString());window.NUCLEAR_VERSION="v5.0.0-NO-DELETE";console.log("🔥 Version: v5.0.0-no-delete");console.log("🔥 Force new build hash:",Math.random());console.log("All data stored in Firestore");console.log("============================");class Fv{constructor(){K(this,"users",[]);K(this,"expenses",[]);K(this,"settlements",[]);K(this,"currentUser",null);K(this,"addExpenseModal");K(this,"authService");K(this,"currentFilter","");this.authService=new Mv;const e=this.authService.getCurrentAuth();e.isAuthenticated&&e.currentUser&&(this.currentUser=e.currentUser,this.initializeData()),this.addExpenseModal=new Ns(this.users,this.currentUser,t=>this.addExpense(t)),this.render(),this.setupEventListeners(),window.editUser=t=>this.editUser(t),window.confirmSettlement=t=>{this.confirmSettlement(t).catch(n=>{alert("❌ Lỗi khi xác nhận thanh toán: "+(n instanceof Error?n.message:n))})},window.confirmMultipleSettlements=t=>{this.confirmMultipleSettlements(t).catch(n=>{alert("❌ Lỗi khi xác nhận thanh toán: "+(n instanceof Error?n.message:n))})}}async initializeData(){try{this.users=await this.authService.getAllUsers(),this.users=this.users.filter(e=>e.isActive),this.expenses=await this.loadExpenses(),this.settlements=await this.loadSettlements()}catch(e){throw console.error("Failed to initialize data:",e),e}}async loadExpenses(){try{return await xe.getExpenses()}catch(e){throw console.error("Failed to load expenses from Firebase:",e),e}}async loadSettlements(){try{return await xe.getSettlements()}catch(e){return console.error("Failed to load settlements from Firebase:",e),[]}}render(){const e=document.getElementById("app");if(!this.currentUser){e.innerHTML=this.renderLoginScreen();return}e.innerHTML=`
    ...
    `}renderBalanceSection(){if(!this.currentUser)return"";const e=this.calculateBalancesWithSettlements(),t=e[this.currentUser.id];return t?new Dd(t,this.users,e).render():`
