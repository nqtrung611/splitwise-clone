...
* See the License for the specific language governing permissions and
* limitations under the License.
*/const Bd=()=>Fd().__FIREBASE_DEFAULTS__,$d=()=>{if(typeof process>"u"||typeof ja>"u")return;const s=ja.__FIREBASE_DEFAULTS__;if(s)return JSON.parse(s)},jd=()=>{if(typeof document>"u")return;let s;try{s=document.cookie.match(/__FIREBASE_DEFAULTS__=([^;]+)/)}catch{return}const e=s&&xl(s[1]);return e&&JSON.parse(e)},fr=()=>{try{return Pd()||Bd()||$d()||jd()}catch(s){console.info(`Unable to get __FIREBASE_DEFAULTS__ due to: ${s}`);return}},Tl=s=>{var e,t;return(t=(e=fr())==null?void 0:e.emulatorHosts)==null?void 0:t[s]},qd=s=>{const e=Tl(s);if(!e)return;const t=e.lastIndexOf(":");if(t<=0||t+1===e.length)throw new Error(`Invalid host ${e} with no separate hostname and port!`);const n=parseInt(e.substring(t+1),10);return e[0]==="["?[e.substring(1,t-1),n]:[e.substring(0,t),n]},_l=()=>{var s;return(s=fr())==null?void 0:s.config},Sl=s=>{var e;return(e=fr())==null?void 0:e[`_${s}`]};/**
* @license
* Copyright 2017 Google LLC
*
* Licensed under the Apache License, Version 2.0 (the "License");
...
* See the License for the specific language governing permissions and
* limitations under the License.
*/function xr(s){return new Cm(s,!0)}/**
* @license
* Copyright 2017 Google LLC
*
* Licensed under the Apache License, Version 2.0 (the "License");
...
* See the License for the specific language governing permissions and
* limitations under the License.
*/const Tt="FirestoreClient";class ly{constructor(e,t,n,r,o){this.authCredentials=e,this.appCheckCredentials=t,this.asyncQueue=n,this.databaseInfo=r,this.user=be.UNAUTHENTICATED,this.clientId=Qi.newId(),this.authCredentialListener=()=>Promise.resolve(),this.appCheckCredentialListener=()=>Promise.resolve(),this._uninitializedComponentsProvider=o,this.authCredentials.start(n,async a=>{O(Tt,"Received user=",a.uid),await this.authCredentialListener(a),this.user=a}),this.appCheckCredentials.start(n,a=>(O(Tt,"Received new app check token=",a),this.appCheckCredentialListener(a,this.user)))}get configuration(){return{asyncQueue:this.asyncQueue,databaseInfo:this.databaseInfo,clientId:this.clientId,authCredentials:this.authCredentials,appCheckCredentials:this.appCheckCredentials,initialUser:this.user,maxConcurrentLimboResolutions:100}}setCredentialChangeListener(e){this.authCredentialListener=e}setAppCheckTokenChangeListener(e){this.appCheckCredentialListener=e}terminate(){this.asyncQueue.enterRestrictedMode();const e=new Qe;return this.asyncQueue.enqueueAndForgetEvenWhileRestricted(async()=>{try{this._onlineComponents&&await this._onlineComponents.terminate(),this._offlineComponents&&await this._offlineComponents.terminate(),this.authCredentials.shutdown(),this.appCheckCredentials.shutdown(),e.resolve()}catch(t){const n=go(t,"Failed to shutdown persistence");e.reject(n)}}),e.promise}}async function pi(s,e){s.asyncQueue.verifyOperationInProgress(),O(Tt,"Initializing OfflineComponentProvider");const t=s.configuration;await e.initialize(t);let n=t.initialUser;s.setCredentialChangeListener(async r=>{n.isEqual(r)||(await Ru(e.localStore,r),n=r)}),e.persistence.setDatabaseDeletedListener(()=>s.terminate()),s._offlineComponents=e}async function qc(s,e){s.asyncQueue.verifyOperationInProgress();const t=await uy(s);O(Tt,"Initializing OnlineComponentProvider"),await e.initialize(t,s.configuration),s.setCredentialChangeListener(n=>Uc(e.remoteStore,n)),s.setAppCheckTokenChangeListener((n,r)=>Uc(e.remoteStore,r)),s._onlineComponents=e}async function uy(s){if(!s._offlineComponents)if(s._uninitializedComponentsProvider){O(Tt,"Using user provided OfflineComponentProvider");try{await pi(s,s._uninitializedComponentsProvider._offline)}catch(e){const t=e;if(!function(n){return n.name==="FirebaseError"?n.code===S.FAILED_PRECONDITION||n.code===S.UNIMPLEMENTED:!(typeof DOMException<"u"&&n instanceof DOMException)||n.code===22||n.code===20||n.code===11}(t))throw t;an("Error using user provided cache. Falling back to memory cache: "+t),await pi(s,new ir)}}else O(Tt,"Using default OfflineComponentProvider"),await pi(s,new cy(void 0));return s._offlineComponents}async function eh(s){return s._onlineComponents||(s._uninitializedComponentsProvider?(O(Tt,"Using user provided OnlineComponentProvider"),await qc(s,s._uninitializedComponentsProvider._online)):(O(Tt,"Using default OnlineComponentProvider"),await qc(s,new Fi))),s._onlineComponents}function hy(s){return eh(s).then(e=>e.syncEngine)}async function th(s){const e=await eh(s),t=e.eventManager;return t.onListen=Wg.bind(null,e.syncEngine),t.onUnlisten=Yg.bind(null,e.syncEngine),t.onFirstRemoteStoreListen=Jg.bind(null,e.syncEngine),t.onLastRemoteStoreUnlisten=Zg.bind(null,e.syncEngine),t}function dy(s,e,t={}){const n=new Qe;return s.asyncQueue.enqueueAndForget(async()=>function(r,o,a,l,u){const d=new Zu({next:m=>{d.Nu(),o.enqueueAndForget(()=>qu(r,p));const T=m.docs.has(a);!T&&m.fromCache?u.reject(new D(S.UNAVAILABLE,"Failed to get document because the client is offline.")):T&&m.fromCache&&l&&l.source==="server"?u.reject(new D(S.UNAVAILABLE,'Failed to get document from server. (However, this document does exist in the local cache. Run again without setting source to "server" to retrieve the cached document.)')):u.resolve(m)},error:m=>u.reject(m)}),p=new zu(eo(a.path),d,{includeMetadataChanges:!0,qa:!0});return ju(r,p)}(await th(s),s.asyncQueue,e,t,n)),n.promise}function fy(s,e,t={}){const n=new Qe;return s.asyncQueue.enqueueAndForget(async()=>function(r,o,a,l,u){const d=new Zu({next:m=>{d.Nu(),o.enqueueAndForget(()=>qu(r,p)),m.fromCache&&l.source==="server"?u.reject(new D(S.UNAVAILABLE,'Failed to get documents from server. (However, these documents may exist in the local cache. Run again without setting source to "server" to retrieve the cached documents.)')):u.resolve(m)},error:m=>u.reject(m)}),p=new zu(a,d,{includeMetadataChanges:!0,qa:!0});return ju(r,p)}(await th(s),s.asyncQueue,e,t,n)),n.promise}/**
* @license
* Copyright 2023 Google LLC
*
* Licensed under the Apache License, Version 2.0 (the "License");
...
* See the License for the specific language governing permissions and
* limitations under the License.
*/function ol(s){const e=s.toLowerCase();if(e.includes("opera/")||e.includes("opr/")||e.includes("opios/"))return"Opera";if(Th(e))return"IEMobile";if(e.includes("msie")||e.includes("trident/"))return"IE";if(e.includes("edge/"))return"Edge";if(Eh(e))return"Firefox";if(e.includes("silk/"))return"Silk";if(Sh(e))return"Blackberry";if(Ch(e))return"Webos";if(Ih(e))return"Safari";if((e.includes("chrome/")||xh(e))&&!e.includes("edge/"))return"Chrome";if(_h(e))return"Android";{const t=/([a-zA-Z\d\.]+)\/[a-zA-Z\d\.]*$/,n=s.match(t);if((n==null?void 0:n.length)===2)return n[1]}return"Other"}function Eh(s=Ie()){return/firefox\//i.test(s)}function Ih(s=Ie()){const e=s.toLowerCase();return e.includes("safari/")&&!e.includes("chrome/")&&!e.includes("crios/")&&!e.includes("android")}function xh(s=Ie()){return/crios\//i.test(s)}function Th(s=Ie()){return/iemobile/i.test(s)}function _h(s=Ie()){return/android/i.test(s)}function Sh(s=Ie()){return/blackberry/i.test(s)}function Ch(s=Ie()){return/webos/i.test(s)}function Oo(s=Ie()){return/iphone|ipad|ipod/i.test(s)||/macintosh/i.test(s)&&/mobile/i.test(s)}function tv(s=Ie()){var e;return Oo(s)&&!!((e=window.navigator)!=null&&e.standalone)}function nv(){return Zd()&&document.documentMode===10}function Ah(s=Ie()){return Oo(s)||_h(s)||Ch(s)||Sh(s)||/windows phone/i.test(s)||Th(s)}/**
* @license
* Copyright 2020 Google LLC
*
* Licensed under the Apache License, Version 2.0 (the "License");
...
* See the License for the specific language governing permissions and
* limitations under the License.
*/const pw={location:"yes",resizable:"yes",statusbar:"yes",toolbar:"no"},mw=500,gw=600,yw="_blank",vw="http://localhost";class pl{constructor(e){this.window=e,this.associatedEvent=null}close(){if(this.window)try{this.window.close()}catch{}}}function ww(s,e,t,n=mw,r=gw){const o=Math.max((window.screen.availHeight-r)/2,0).toString(),a=Math.max((window.screen.availWidth-n)/2,0).toString();let l="";const u={...pw,width:n.toString(),height:r.toString(),top:o,left:a},d=Ie().toLowerCase();t&&(l=xh(d)?yw:t),Eh(d)&&(e=e||vw,u.scrollbars="yes");const p=Object.entries(u).reduce((T,[A,N])=>`${T}${A}=${N},`,"");if(tv(d)&&l!=="_self")return bw(e||"",l),new pl(null);const m=window.open(e||"",l,p);U(m,s,"popup-blocked");try{m.focus()}catch{}return new pl(m)}function bw(s,e){const t=document.createElement("a");t.href=s,t.target=e;const n=document.createEvent("MouseEvent");n.initMouseEvent("click",!0,!0,window,1,0,0,0,0,!1,!1,!1,!1,1,null),t.dispatchEvent(n)}/**
* @license
* Copyright 2021 Google LLC
*
* Licensed under the Apache License, Version 2.0 (the "License");
...
* See the License for the specific language governing permissions and
* limitations under the License.
*/const Ew="__/auth/handler",Iw="emulator/auth/handler",xw=encodeURIComponent("fac");async function ml(s,e,t,n,r,o){U(s.config.authDomain,s,"auth-domain-config-required"),U(s.config.apiKey,s,"invalid-api-key");const a={apiKey:s.config.apiKey,appName:s.name,authType:t,redirectUrl:n,v:mn,eventId:r};if(e instanceof Rh){e.setDefaultLanguage(s.languageCode),a.providerId=e.providerId||"",af(e.getCustomParameters())||(a.customParameters=JSON.stringify(e.getCustomParameters()));for(const[p,m]of Object.entries({}))a[p]=m}if(e instanceof ps){const p=e.getScopes().filter(m=>m!=="");p.length>0&&(a.scopes=p.join(","))}s.tenantId&&(a.tid=s.tenantId);const l=a;for(const p of Object.keys(l))l[p]===void 0&&delete l[p];const u=await s._getAppCheckToken(),d=u?`#${xw}=${encodeURIComponent(u)}`:"";return`${Tw(s)}?${os(l).slice(1)}${d}`}function Tw({config:s}){return s.emulator?Do(s,Iw):`https://${s.authDomain}/${Ew}`}/**
* @license
* Copyright 2020 Google LLC
*
* Licensed under the Apache License, Version 2.0 (the "License");
