...
* See the License for the specific language governing permissions and
* limitations under the License.
*/const Md=()=>Pd().__FIREBASE_DEFAULTS__,Ud=()=>{if(typeof process>"u"||typeof ja>"u")return;const s=ja.__FIREBASE_DEFAULTS__;if(s)return JSON.parse(s)},Fd=()=>{if(typeof document>"u")return;let s;try{s=document.cookie.match(/__FIREBASE_DEFAULTS__=([^;]+)/)}catch{return}const e=s&&Tl(s[1]);return e&&JSON.parse(e)},fi=()=>{try{return Dd()||Md()||Ud()||Fd()}catch(s){console.info(`Unable to get __FIREBASE_DEFAULTS__ due to: ${s}`);return}},Sl=s=>{var e,t;return(t=(e=fi())==null?void 0:e.emulatorHosts)==null?void 0:t[s]},Vd=s=>{const e=Sl(s);if(!e)return;const t=e.lastIndexOf(":");if(t<=0||t+1===e.length)throw new Error(`Invalid host ${e} with no separate hostname and port!`);const n=parseInt(e.substring(t+1),10);return e[0]==="["?[e.substring(1,t-1),n]:[e.substring(0,t),n]},Il=()=>{var s;return(s=fi())==null?void 0:s.config},_l=s=>{var e;return(e=fi())==null?void 0:e[`_${s}`]};/**
* @license
* Copyright 2017 Google LLC
*
* Licensed under the Apache License, Version 2.0 (the "License");
...
* See the License for the specific language governing permissions and
* limitations under the License.
*/class Af{constructor(e){this.container=e}getPlatformInfoString(){return this.container.getProviders().map(e=>{if(Cf(e)){const t=e.getImmediate();return`${t.library}/${t.version}`}else return null}).filter(e=>e).join(" ")}}function Cf(s){const e=s.getComponent();return(e==null?void 0:e.type)==="VERSION"}const br="@firebase/app",Ka="0.14.4";/**
* @license
* Copyright 2019 Google LLC
*
* Licensed under the Apache License, Version 2.0 (the "License");
...
* See the License for the specific language governing permissions and
* limitations under the License.
*/const Qs=new Map,np=new Map,Tr=new Map;function Wa(s,e){try{s.container.addComponent(e)}catch(t){Xe.debug(`Component ${e.name} failed to register with FirebaseApp ${s.name}`,t)}}function on(s){const e=s.name;if(Tr.has(e))return Xe.debug(`There were multiple attempts to register component ${e}.`),!1;Tr.set(e,s);for(const t of Qs.values())Wa(t,s);for(const t of np.values())Wa(t,s);return!0}function Gr(s,e){const t=s.container.getProvider("heartbeat").getImmediate({optional:!0});return t&&t.triggerHeartbeat(),s.container.getProvider(e)}function Ve(s){return s==null?!1:s.settings!==void 0}/**
* @license
* Copyright 2019 Google LLC
*
* Licensed under the Apache License, Version 2.0 (the "License");
...
* See the License for the specific language governing permissions and
* limitations under the License.
*/const mn=ep;function Nl(s,e={}){let t=s;typeof e!="object"&&(e={name:e});const n={name:Er,automaticDataCollectionEnabled:!0,...e},i=n.name;if(typeof i!="string"||!i)throw gt.create("bad-app-name",{appName:String(i)});if(t||(t=Il()),!t)throw gt.create("no-options");const o=Qs.get(i);if(o){if(Ut(t,o.options)&&Ut(n,o.config))return o;throw gt.create("duplicate-app",{appName:i})}const a=new uf(i);for(const u of Tr.values())a.addComponent(u);const l=new ip(t,n,a);return Qs.set(i,l),l}function Dl(s=Er){const e=Qs.get(s);if(!e&&s===Er&&Il())return Nl();if(!e)throw gt.create("no-app",{appName:s});return e}function yt(s,e,t){let n=tp[s]??s;t&&(n+=`-${t}`);const i=n.match(/\s|\//),o=e.match(/\s|\//);if(i||o){const a=[`Unable to register library "${n}" with version "${e}":`];i&&a.push(`library name "${n}" contains illegal characters (whitespace or "/")`),i&&o&&a.push("and"),o&&a.push(`version name "${e}" contains illegal characters (whitespace or "/")`),Xe.warn(a.join(" "));return}on(new Ft(`${n}-version`,()=>({library:n,version:e}),"VERSION"))}/**
* @license
* Copyright 2021 Google LLC
*
* Licensed under the Apache License, Version 2.0 (the "License");
...
* See the License for the specific language governing permissions and
* limitations under the License.
*/class xe{constructor(e){this.value=e}static empty(){return new xe({mapValue:{}})}field(e){if(e.isEmpty())return this.value;{let t=this.value;for(let n=0;n<e.length-1;++n)if(t=(t.mapValue.fields||{})[e.get(n)],!Vs(t))return null;return t=(t.mapValue.fields||{})[e.lastSegment()],t||null}}set(e,t){this.getFieldsMap(e.popLast())[e.lastSegment()]=Hn(t)}setAll(e){let t=ge.emptyPath(),n={},i=[];e.forEach((a,l)=>{if(!t.isImmediateParentOf(l)){const u=this.getFieldsMap(t);this.applyChanges(u,n,i),n={},i=[],t=l.popLast()}a?n[l.lastSegment()]=Hn(a):i.push(l.lastSegment())});const o=this.getFieldsMap(t);this.applyChanges(o,n,i)}delete(e){const t=this.field(e.popLast());Vs(t)&&t.mapValue.fields&&delete t.mapValue.fields[e.lastSegment()]}isEqual(e){return Ge(this.value,e.value)}getFieldsMap(e){let t=this.value;t.mapValue.fields||(t.mapValue={fields:{}});for(let n=0;n<e.length;++n){let i=t.mapValue.fields[e.get(n)];Vs(i)&&i.mapValue.fields||(i={mapValue:{fields:{}}},t.mapValue.fields[e.get(n)]=i),t=i}return t.mapValue.fields}applyChanges(e,t,n){At(t,(i,o)=>e[i]=o);for(const i of n)delete e[i]}clone(){return new xe(Hn(this.value))}}function Zl(s){const e=[];return At(s.fields,(t,n)=>{const i=new ge([t]);if(Vs(n)){const o=Zl(n.mapValue).fields;if(o.length===0)e.push(i);else for(const a of o)e.push(i.child(a))}else e.push(i)}),new Ne(e)}/**
* @license
* Copyright 2017 Google LLC
*
* Licensed under the Apache License, Version 2.0 (the "License");
...
* See the License for the specific language governing permissions and
* limitations under the License.
*/const vm=new vt([4294967295,4294967295],0);function Sc(s){const e=ym().encode(s),t=new Ol;return t.update(e),new Uint8Array(t.digest())}function Ic(s){const e=new DataView(s.buffer),t=e.getUint32(0,!0),n=e.getUint32(4,!0),i=e.getUint32(8,!0),o=e.getUint32(12,!0);return[new vt([t,n],0),new vt([i,o],0)]}class io{constructor(e,t,n){if(this.bitmap=e,this.padding=t,this.hashCount=n,t<0||t>=8)throw new $n(`Invalid padding: ${t}`);if(n<0)throw new $n(`Invalid hash count: ${n}`);if(e.length>0&&this.hashCount===0)throw new $n(`Invalid hash count: ${n}`);if(e.length===0&&t!==0)throw new $n(`Invalid padding when bitmap length is 0: ${t}`);this.ge=8*e.length-t,this.pe=vt.fromNumber(this.ge)}ye(e,t,n){let i=e.add(t.multiply(vt.fromNumber(n)));return i.compare(vm)===1&&(i=new vt([i.getBits(0),i.getBits(1)],0)),i.modulo(this.pe).toNumber()}we(e){return!!(this.bitmap[Math.floor(e/8)]&1<<e%8)}mightContain(e){if(this.ge===0)return!1;const t=Sc(e),[n,i]=Ic(t);for(let o=0;o<this.hashCount;o++){const a=this.ye(n,i,o);if(!this.we(a))return!1}return!0}static create(e,t,n){const i=e%8==0?0:8-e%8,o=new Uint8Array(Math.ceil(e/8)),a=new io(o,i,t);return n.forEach(l=>a.insert(l)),a}insert(e){if(this.ge===0)return;const t=Sc(e),[n,i]=Ic(t);for(let o=0;o<this.hashCount;o++){const a=this.ye(n,i,o);this.Se(a)}}Se(e){const t=Math.floor(e/8),n=e%8;this.bitmap[t]|=1<<n}}class $n extends Error{constructor(){super(...arguments),this.name="BloomFilterError"}}/**
* @license
* Copyright 2017 Google LLC
*
* Licensed under the Apache License, Version 2.0 (the "License");
...
* See the License for the specific language governing permissions and
* limitations under the License.
*/class Ti{constructor(e,t,n,i,o){this.snapshotVersion=e,this.targetChanges=t,this.targetMismatches=n,this.documentUpdates=i,this.resolvedLimboDocuments=o}static createSynthesizedRemoteEventForCurrentChange(e,t,n){const i=new Map;return i.set(e,ls.createSynthesizedTargetChangeForCurrentChange(e,t,n)),new Ti(F.min(),i,new te(q),Ze(),z())}}class ls{constructor(e,t,n,i,o){this.resumeToken=e,this.current=t,this.addedDocuments=n,this.modifiedDocuments=i,this.removedDocuments=o}static createSynthesizedTargetChangeForCurrentChange(e,t,n){return new ls(n,t,z(),z(),z())}}/**
* @license
* Copyright 2017 Google LLC
*
* Licensed under the Apache License, Version 2.0 (the "License");
...
* See the License for the specific language governing permissions and
* limitations under the License.
*/const we="WebChannelConnection";class wg extends yg{constructor(e){super(e),this.c_=[],this.forceLongPolling=e.forceLongPolling,this.autoDetectLongPolling=e.autoDetectLongPolling,this.useFetchStreams=e.useFetchStreams,this.longPollingOptions=e.longPollingOptions}Jo(e,t,n,i,o){const a=Mr();return new Promise((l,u)=>{const d=new Pl;d.setWithCredentials(!0),d.listenOnce(Ml.COMPLETE,()=>{try{switch(d.getLastErrorCode()){case Us.NO_ERROR:const m=d.getResponseJson();O(we,`XHR for RPC '${e}' ${a} received:`,JSON.stringify(m)),l(m);break;case Us.TIMEOUT:O(we,`RPC '${e}' ${a} timed out`),u(new D(A.DEADLINE_EXCEEDED,"Request time out"));break;case Us.HTTP_ERROR:const I=d.getStatus();if(O(we,`RPC '${e}' ${a} failed with status:`,I,"response text:",d.getResponseText()),I>0){let x=d.getResponseJson();Array.isArray(x)&&(x=x[0]);const N=x==null?void 0:x.error;if(N&&N.status&&N.message){const L=function(R){const B=R.toLowerCase().replace(/_/g,"-");return Object.values(A).indexOf(B)>=0?B:A.UNKNOWN}(N.status);u(new D(L,N.message))}else u(new D(A.UNKNOWN,"Server responded with status "+d.getStatus()))}else u(new D(A.UNAVAILABLE,"Connection failed."));break;default:M(9055,{l_:e,streamId:a,h_:d.getLastErrorCode(),P_:d.getLastError()})}}finally{O(we,`RPC '${e}' ${a} completed.`)}});const p=JSON.stringify(i);O(we,`RPC '${e}' ${a} sending request:`,i),d.send(t,"POST",p,n,15)})}T_(e,t,n){const i=Mr(),o=[this.Uo,"/","google.firestore.v1.Firestore","/",e,"/channel"],a=Vl(),l=Fl(),u={httpSessionIdParam:"gsessionid",initMessageHeaders:{},messageUrlParams:{database:`projects/${this.databaseId.projectId}/databases/${this.databaseId.database}`},sendRawJson:!0,supportsCrossDomainXhr:!0,internalChannelParams:{forwardChannelRequestTimeoutMs:6e5},forceLongPolling:this.forceLongPolling,detectBufferingProxy:this.autoDetectLongPolling},d=this.longPollingOptions.timeoutSeconds;d!==void 0&&(u.longPollingTimeout=Math.round(1e3*d)),this.useFetchStreams&&(u.useFetchStreams=!0),this.jo(u.initMessageHeaders,t,n),u.encodeInitMessageHeaders=!0;const p=o.join("");O(we,`Creating RPC '${e}' stream ${i}: ${p}`,u);const m=a.createWebChannel(p,u);this.I_(m);let I=!1,x=!1;const N=new vg({Yo:R=>{x?O(we,`Not sending because RPC '${e}' stream ${i} is closed:`,R):(I||(O(we,`Opening RPC '${e}' stream ${i} transport.`),m.open(),I=!0),O(we,`RPC '${e}' stream ${i} sending:`,R),m.send(R))},Zo:()=>m.close()}),L=(R,B,G)=>{R.listen(B,Z=>{try{G(Z)}catch(ne){setTimeout(()=>{throw ne},0)}})};return L(m,Bn.EventType.OPEN,()=>{x||(O(we,`RPC '${e}' stream ${i} transport opened.`),N.o_())}),L(m,Bn.EventType.CLOSE,()=>{x||(x=!0,O(we,`RPC '${e}' stream ${i} transport closed`),N.a_(),this.E_(m))}),L(m,Bn.EventType.ERROR,R=>{x||(x=!0,an(we,`RPC '${e}' stream ${i} transport errored. Name:`,R.name,"Message:",R.message),N.a_(new D(A.UNAVAILABLE,"The operation could not be completed")))}),L(m,Bn.EventType.MESSAGE,R=>{var B;if(!x){const G=R.data[0];W(!!G,16349);const Z=G,ne=(Z==null?void 0:Z.error)||((B=Z[0])==null?void 0:B.error);if(ne){O(we,`RPC '${e}' stream ${i} received error:`,ne);const ue=ne.status;let ee=function(g){const v=oe[g];if(v!==void 0)return wu(v)}(ue),b=ne.message;ee===void 0&&(ee=A.INTERNAL,b="Unknown error status: "+ue+" with message "+ne.message),x=!0,N.a_(new D(ee,b)),m.close()}else O(we,`RPC '${e}' stream ${i} received:`,G),N.u_(G)}}),L(l,Ul.STAT_EVENT,R=>{R.stat===Sr.PROXY?O(we,`RPC '${e}' stream ${i} detected buffering proxy`):R.stat===Sr.NOPROXY&&O(we,`RPC '${e}' stream ${i} detected no buffering proxy`)}),setTimeout(()=>{N.__()},0),N}terminate(){this.c_.forEach(e=>e.close()),this.c_=[]}I_(e){this.c_.push(e)}E_(e){this.c_=this.c_.filter(t=>t===e)}}function fr(){return typeof document<"u"?document:null}/**
* @license
* Copyright 2020 Google LLC
*
* Licensed under the Apache License, Version 2.0 (the "License");
...
* See the License for the specific language governing permissions and
* limitations under the License.
*/const Bt="RemoteStore";class _g{constructor(e,t,n,i,o){this.localStore=e,this.datastore=t,this.asyncQueue=n,this.remoteSyncer={},this.Ta=[],this.Ia=new Map,this.Ea=new Set,this.da=[],this.Aa=o,this.Aa.Oo(a=>{n.enqueueAndForget(async()=>{qt(this)&&(O(Bt,"Restarting streams for network reachability change."),await async function(l){const u=V(l);u.Ea.add(4),await us(u),u.Ra.set("Unknown"),u.Ea.delete(4),await Ii(u)}(this))})}),this.Ra=new Ig(n,i)}}async function Ii(s){if(qt(s))for(const e of s.da)await e(!0)}async function us(s){for(const e of s.da)await e(!1)}function Pu(s,e){const t=V(s);t.Ia.has(e.targetId)||(t.Ia.set(e.targetId,e),po(t)?fo(t):bn(t).O_()&&ho(t,e))}function uo(s,e){const t=V(s),n=bn(t);t.Ia.delete(e),n.O_()&&Mu(t,e),t.Ia.size===0&&(n.O_()?n.L_():qt(t)&&t.Ra.set("Unknown"))}function ho(s,e){if(s.Va.Ue(e.targetId),e.resumeToken.approximateByteSize()>0||e.snapshotVersion.compareTo(F.min())>0){const t=s.remoteSyncer.getRemoteKeysForTarget(e.targetId).size;e=e.withExpectedCount(t)}bn(s).Y_(e)}function Mu(s,e){s.Va.Ue(e),bn(s).Z_(e)}function fo(s){s.Va=new wm({getRemoteKeysForTarget:e=>s.remoteSyncer.getRemoteKeysForTarget(e),At:e=>s.Ia.get(e)||null,ht:()=>s.datastore.serializer.databaseId}),bn(s).start(),s.Ra.ua()}function po(s){return qt(s)&&!bn(s).x_()&&s.Ia.size>0}function qt(s){return V(s).Ea.size===0}function Uu(s){s.Va=void 0}async function Ag(s){s.Ra.set("Online")}async function Cg(s){s.Ia.forEach((e,t)=>{ho(s,e)})}async function xg(s,e){Uu(s),po(s)?(s.Ra.ha(e),fo(s)):s.Ra.set("Unknown")}async function kg(s,e,t){if(s.Ra.set("Online"),e instanceof Eu&&e.state===2&&e.cause)try{await async function(n,i){const o=i.cause;for(const a of i.targetIds)n.Ia.has(a)&&(await n.remoteSyncer.rejectListen(a,o),n.Ia.delete(a),n.Va.removeTarget(a))}(s,e)}catch(n){O(Bt,"Failed to remove targets %s: %s ",e.targetIds.join(","),n),await ii(s,n)}else if(e instanceof js?s.Va.Ze(e):e instanceof bu?s.Va.st(e):s.Va.tt(e),!t.isEqual(F.min()))try{const n=await Ru(s.localStore);t.compareTo(n)>=0&&await function(i,o){const a=i.Va.Tt(o);return a.targetChanges.forEach((l,u)=>{if(l.resumeToken.approximateByteSize()>0){const d=i.Ia.get(u);d&&i.Ia.set(u,d.withResumeToken(l.resumeToken,o))}}),a.targetMismatches.forEach((l,u)=>{const d=i.Ia.get(l);if(!d)return;i.Ia.set(l,d.withResumeToken(ye.EMPTY_BYTE_STRING,d.snapshotVersion)),Mu(i,l);const p=new pt(d.target,l,u,d.sequenceNumber);ho(i,p)}),i.remoteSyncer.applyRemoteEvent(a)}(s,t)}catch(n){O(Bt,"Failed to raise snapshot:",n),await ii(s,n)}}async function ii(s,e,t){if(!vn(e))throw e;s.Ea.add(1),await us(s),s.Ra.set("Offline"),t||(t=()=>Ru(s.localStore)),s.asyncQueue.enqueueRetryable(async()=>{O(Bt,"Retrying IndexedDB access"),await t(),s.Ea.delete(1),await Ii(s)})}function Fu(s,e){return e().catch(t=>ii(s,t,e))}async function _i(s){const e=V(s),t=It(e);let n=e.Ta.length>0?e.Ta[e.Ta.length-1].batchId:Qr;for(;Ng(e);)try{const i=await hg(e.localStore,n);if(i===null){e.Ta.length===0&&t.L_();break}n=i.batchId,Dg(e,i)}catch(i){await ii(e,i)}Vu(e)&&Bu(e)}function Ng(s){return qt(s)&&s.Ta.length<10}function Dg(s,e){s.Ta.push(e);const t=It(s);t.O_()&&t.X_&&t.ea(e.mutations)}function Vu(s){return qt(s)&&!It(s).x_()&&s.Ta.length>0}function Bu(s){It(s).start()}async function Rg(s){It(s).ra()}async function Lg(s){const e=It(s);for(const t of s.Ta)e.ea(t.mutations)}async function Og(s,e,t){const n=s.Ta.shift(),i=so.from(n,e,t);await Fu(s,()=>s.remoteSyncer.applySuccessfulWrite(i)),await _i(s)}async function Pg(s,e){e&&It(s).X_&&await async function(t,n){if(function(i){return gm(i)&&i!==A.ABORTED}(n.code)){const i=t.Ta.shift();It(t).B_(),await Fu(t,()=>t.remoteSyncer.rejectFailedWrite(i.batchId,n)),await _i(t)}}(s,e),Vu(s)&&Bu(s)}async function Mc(s,e){const t=V(s);t.asyncQueue.verifyOperationInProgress(),O(Bt,"RemoteStore received new credentials");const n=qt(t);t.Ea.add(3),await us(t),n&&t.Ra.set("Unknown"),await t.remoteSyncer.handleCredentialChange(e),t.Ea.delete(3),await Ii(t)}async function Mg(s,e){const t=V(s);e?(t.Ea.delete(2),await Ii(t)):e||(t.Ea.add(2),await us(t),t.Ra.set("Unknown"))}function bn(s){return s.ma||(s.ma=function(e,t,n){const i=V(e);return i.sa(),new bg(t,i.connection,i.authCredentials,i.appCheckCredentials,i.serializer,n)}(s.datastore,s.asyncQueue,{Xo:Ag.bind(null,s),t_:Cg.bind(null,s),r_:xg.bind(null,s),H_:kg.bind(null,s)}),s.da.push(async e=>{e?(s.ma.B_(),po(s)?fo(s):s.Ra.set("Unknown")):(await s.ma.stop(),Uu(s))})),s.ma}function It(s){return s.fa||(s.fa=function(e,t,n){const i=V(e);return i.sa(),new Eg(t,i.connection,i.authCredentials,i.appCheckCredentials,i.serializer,n)}(s.datastore,s.asyncQueue,{Xo:()=>Promise.resolve(),t_:Rg.bind(null,s),r_:Pg.bind(null,s),ta:Lg.bind(null,s),na:Og.bind(null,s)}),s.da.push(async e=>{e?(s.fa.B_(),await _i(s)):(await s.fa.stop(),s.Ta.length>0&&(O(Bt,`Stopping write stream with ${s.Ta.length} pending writes`),s.Ta=[]))})),s.fa}/**
* @license
* Copyright 2017 Google LLC
*
* Licensed under the Apache License, Version 2.0 (the "License");
...
* See the License for the specific language governing permissions and
* limitations under the License.
*/function Cy(s){s=Ye(s,le);const e=Ye(s.firestore,En);return cy(bo(e),s._key).then(t=>ky(e,s,t))}tn._jsonSchemaVersion="firestore/querySnapshot/1.0",tn._jsonSchema={type:ce("string",tn._jsonSchemaVersion),bundleSource:ce("string","QuerySnapshot"),bundleName:ce("string"),bundle:ce("string")};class hh extends Iy{constructor(e){super(),this.firestore=e}convertBytes(e){return new De(e)}convertReference(e){const t=this.convertDocumentKey(e,this.firestore._databaseId);return new le(this.firestore,null,t)}}function Vn(s){s=Ye(s,zt);const e=Ye(s.firestore,En),t=bo(e),n=new hh(e);return Ty(s._query),ly(t,s._query).then(i=>new tn(e,n,s,i))}function xy(s,e,t,...n){s=Ye(s,le);const i=Ye(s.firestore,En),o=So(i);let a;return a=typeof(e=_e(e))=="string"||e instanceof Ci?vy(o,"updateDoc",s._key,e,t,n):yy(o,"updateDoc",s._key,e),ko(i,[a.toMutation(s._key,Le.exists(!0))])}function Zc(s){return ko(Ye(s.firestore,En),[new no(s._key,Le.none())])}function el(s,e){const t=Ye(s.firestore,En),n=$s(s),i=_y(s.converter,e);return ko(t,[gy(So(s.firestore),"addDoc",n._key,i,s.converter!==null,{}).toMutation(n._key,Le.exists(!1))]).then(()=>n)}function ko(s,e){return function(t,n){const i=new Qe;return t.asyncQueue.enqueueAndForget(async()=>Xg(await ay(t),n,i)),i.promise}(bo(s),e)}function ky(s,e,t){const n=t.docs.get(e._key),i=new hh(s);return new Pt(s,i,e._key,n,new qn(t.hasPendingWrites,t.fromCache),e.converter)}(function(s,e=!0){(function(t){gn=t})(mn),on(new Ft("firestore",(t,{instanceIdentifier:n,options:i})=>{const o=t.getProvider("app").getImmediate(),a=new En(new yp(t.getProvider("auth-internal")),new bp(o,t.getProvider("app-check-internal")),function(l,u){if(!Object.prototype.hasOwnProperty.apply(l.options,["projectId"]))throw new D(A.INVALID_ARGUMENT,'"projectId" not provided in firebase.initializeApp.');return new Zn(l.options.projectId,u)}(o,n),o);return i={useFetchStreams:e,...i},a._setSettings(i),a},"PUBLIC").setMultipleInstances(!0)),yt(Za,ec,s),yt(Za,ec,"esm2020")})();const Ny=function(s,e,t){let n=Promise.resolve();function i(o){const a=new Event("vite:preloadError",{cancelable:!0});if(a.payload=o,window.dispatchEvent(a),!a.defaultPrevented)throw o}return n.then(o=>{for(const a of o||[])a.status==="rejected"&&i(a.reason);return s().catch(i)})};var Dy="firebase",Ry="12.4.0";/**
* @license
* Copyright 2020 Google LLC
*
* Licensed under the Apache License, Version 2.0 (the "License");
...
* See the License for the specific language governing permissions and
* limitations under the License.
*/const Vy=["/v1/accounts:signInWithCustomToken","/v1/accounts:signInWithEmailLink","/v1/accounts:signInWithIdp","/v1/accounts:signInWithPassword","/v1/accounts:signInWithPhoneNumber","/v1/token"],By=new fs(3e4,6e4);function Ro(s,e){return s.tenantId&&!e.tenantId?{...e,tenantId:s.tenantId}:e}async function Tn(s,e,t,n,i={}){return gh(s,i,async()=>{let o={},a={};n&&(e==="GET"?a=n:o={body:JSON.stringify(n)});const l=os({key:s.config.apiKey,...a}).slice(1),u=await s._getAdditionalHeaders();u["Content-Type"]="application/json",s.languageCode&&(u["X-Firebase-Locale"]=s.languageCode);const d={method:e,headers:u,...o};return Gd()||(d.referrerPolicy="no-referrer"),s.emulatorConfig&&pn(s.emulatorConfig.host)&&(d.credentials="include"),mh.fetch()(await yh(s,s.config.apiHost,t,l),d)})}async function gh(s,e,t){s._canInitEmulator=!1;const n={...Fy,...e};try{const i=new $y(s),o=await Promise.race([t(),i.promise]);i.clearNetworkTimeout();const a=await o.json();if("needConfirmation"in a)throw Ms(s,"account-exists-with-different-credential",a);if(o.ok&&!("errorMessage"in a))return a;{const l=o.ok?a.errorMessage:a.error.message,[u,d]=l.split(" : ");if(u==="FEDERATED_USER_ID_ALREADY_LINKED")throw Ms(s,"credential-already-in-use",a);if(u==="EMAIL_EXISTS")throw Ms(s,"email-already-in-use",a);if(u==="USER_DISABLED")throw Ms(s,"user-disabled",a);const p=n[u]||u.toLowerCase().replace(/[_\s]+/g,"-");if(d)throw ph(s,p,d);et(s,p)}}catch(i){if(i instanceof nt)throw i;et(s,"network-request-failed",{message:String(i)})}}async function jy(s,e,t,n,i={}){const o=await Tn(s,e,t,n,i);return"mfaPendingCredential"in o&&et(s,"multi-factor-auth-required",{_serverResponse:o}),o}async function yh(s,e,t,n){const i=`${e}${t}?${n}`,o=s,a=o.config.emulator?Do(s.config,i):`${s.config.apiScheme}://${i}`;return Vy.includes(t)&&(await o._persistenceManagerAvailable,o._getPersistenceType()==="COOKIE")?o._getPersistence()._getFinalTarget(a).toString():a}class $y{clearNetworkTimeout(){clearTimeout(this.timer)}constructor(e){this.auth=e,this.timer=null,this.promise=new Promise((t,n)=>{this.timer=setTimeout(()=>n(ze(this.auth,"network-request-failed")),By.get())})}}function Ms(s,e,t){const n={appName:s.name};t.email&&(n.email=t.email),t.phoneNumber&&(n.phoneNumber=t.phoneNumber);const i=ze(s,e,n);return i.customData._tokenResponse=t,i}/**
* @license
* Copyright 2020 Google LLC
*
* Licensed under the Apache License, Version 2.0 (the "License");
...
* See the License for the specific language governing permissions and
* limitations under the License.
*/function rl(s){const e=s.toLowerCase();if(e.includes("opera/")||e.includes("opr/")||e.includes("opios/"))return"Opera";if(Sh(e))return"IEMobile";if(e.includes("msie")||e.includes("trident/"))return"IE";if(e.includes("edge/"))return"Edge";if(bh(e))return"Firefox";if(e.includes("silk/"))return"Silk";if(_h(e))return"Blackberry";if(Ah(e))return"Webos";if(Eh(e))return"Safari";if((e.includes("chrome/")||Th(e))&&!e.includes("edge/"))return"Chrome";if(Ih(e))return"Android";{const t=/([a-zA-Z\d\.]+)\/[a-zA-Z\d\.]*$/,n=s.match(t);if((n==null?void 0:n.length)===2)return n[1]}return"Other"}function bh(s=Te()){return/firefox\//i.test(s)}function Eh(s=Te()){const e=s.toLowerCase();return e.includes("safari/")&&!e.includes("chrome/")&&!e.includes("crios/")&&!e.includes("android")}function Th(s=Te()){return/crios\//i.test(s)}function Sh(s=Te()){return/iemobile/i.test(s)}function Ih(s=Te()){return/android/i.test(s)}function _h(s=Te()){return/blackberry/i.test(s)}function Ah(s=Te()){return/webos/i.test(s)}function Oo(s=Te()){return/iphone|ipad|ipod/i.test(s)||/macintosh/i.test(s)&&/mobile/i.test(s)}function Jy(s=Te()){var e;return Oo(s)&&!!((e=window.navigator)!=null&&e.standalone)}function Yy(){return Qd()&&document.documentMode===10}function Ch(s=Te()){return Oo(s)||Ih(s)||Ah(s)||_h(s)||/windows phone/i.test(s)||Sh(s)}/**
* @license
* Copyright 2020 Google LLC
*
* Licensed under the Apache License, Version 2.0 (the "License");
...
* See the License for the specific language governing permissions and
* limitations under the License.
*/function xh(s,e=[]){let t;switch(s){case"Browser":t=rl(Te());break;case"Worker":t=`${rl(Te())}-${s}`;break;default:t=s}const n=e.length?e.join(","):"FirebaseCore-web";return`${t}/JsCore/${mn}/${n}`}/**
* @license
* Copyright 2022 Google LLC
*
* Licensed under the Apache License, Version 2.0 (the "License");
...
* See the License for the specific language governing permissions and
* limitations under the License.
*/async function ev(s,e={}){return Tn(s,"GET","/v2/passwordPolicy",Ro(s,e))}/**
* @license
* Copyright 2023 Google LLC
*
* Licensed under the Apache License, Version 2.0 (the "License");
...
* See the License for the specific language governing permissions and
* limitations under the License.
*/function cv(s,e){const t=Gr(s,"auth");if(t.isInitialized()){const n=t.getImmediate(),i=t.getOptions();if(Ut(i,e??{}))return n;et(n,"already-initialized")}return t.initialize({options:e})}function lv(s,e){const t=(e==null?void 0:e.persistence)||[],n=(Array.isArray(t)?t:[t]).map(We);e!=null&&e.errorMap&&s._updateErrorMap(e.errorMap),s._initializeWithPersistence(n,e==null?void 0:e.popupRedirectResolver)}function uv(s,e,t){const n=Po(s);U(/^https?:\/\//.test(e),n,"invalid-emulator-scheme");const i=!1,o=kh(e),{host:a,port:l}=hv(e),u=l===null?"":`:${l}`,d={url:`${o}//${a}${u}/`},p=Object.freeze({host:a,port:l,protocol:o.replace(":",""),options:Object.freeze({disableWarnings:i})});if(!n._canInitEmulator){U(n.config.emulator&&n.emulatorConfig,n,"emulator-config-failed"),U(Ut(d,n.config.emulator)&&Ut(p,n.emulatorConfig),n,"emulator-config-failed");return}n.config.emulator=d,n.emulatorConfig=p,n.settings.appVerificationDisabledForTesting=!0,pn(a)?(Al(`${o}//${a}${u}`),Cl("Auth",!0)):dv()}function kh(s){const e=s.indexOf(":");return e<0?"":s.substr(0,e+1)}function hv(s){const e=kh(s),t=/(\/\/)?([^?#/]+)/.exec(s.substr(e.length));if(!t)return{host:"",port:null};const n=t[2].split("@").pop()||"",i=/^(\[[^\]]+\])(:|$)/.exec(n);if(i){const o=i[1];return{host:o,port:al(n.substr(o.length+1))}}else{const[o,a]=n.split(":");return{host:o,port:al(a)}}}function al(s){if(!s)return null;const e=Number(s);return isNaN(e)?null:e}function dv(){function s(){const e=document.createElement("p"),t=e.style;e.innerText="Running in emulator mode. Do not use with production credentials.",t.position="fixed",t.width="100%",t.backgroundColor="#ffffff",t.border=".1em solid #000000",t.color="#b50000",t.bottom="0px",t.left="0px",t.margin="0px",t.zIndex="10000",t.textAlign="center",e.classList.add("firebase-emulator-warning"),document.body.appendChild(e)}typeof console<"u"&&typeof console.info=="function"&&console.info("WARNING: You are using the Auth Emulator, which is intended for local testing only.  Do not use with production credentials."),typeof window<"u"&&typeof document<"u"&&(document.readyState==="loading"?window.addEventListener("DOMContentLoaded",s):s())}/**
* @license
* Copyright 2020 Google LLC
*
* Licensed under the Apache License, Version 2.0 (the "License");
...
* See the License for the specific language governing permissions and
* limitations under the License.
*/function Iw(s){switch(s){case"Node":return"node";case"ReactNative":return"rn";case"Worker":return"webworker";case"Cordova":return"cordova";case"WebExtension":return"web-extension";default:return}}function _w(s){on(new Ft("auth",(e,{options:t})=>{const n=e.getProvider("app").getImmediate(),i=e.getProvider("heartbeat"),o=e.getProvider("app-check-internal"),{apiKey:a,authDomain:l}=n.options;U(a&&!a.includes(":"),"invalid-api-key",{appName:n.name});const u={apiKey:a,authDomain:l,clientPlatform:s,apiHost:"identitytoolkit.googleapis.com",tokenApiHost:"securetoken.googleapis.com",apiScheme:"https",sdkClientVersion:xh(s)},d=new sv(n,i,o,u);return lv(d,t),d},"PUBLIC").setInstantiationMode("EXPLICIT").setInstanceCreatedCallback((e,t,n)=>{e.getProvider("auth-internal").initialize()})),on(new Ft("auth-internal",e=>{const t=Po(e.getProvider("auth").getImmediate());return(n=>new Sw(n))(t)},"PRIVATE").setInstantiationMode("EXPLICIT")),yt(ml,gl,Iw(s)),yt(ml,gl,"esm2020")}/**
* @license
* Copyright 2021 Google LLC
*
* Licensed under the Apache License, Version 2.0 (the "License");
